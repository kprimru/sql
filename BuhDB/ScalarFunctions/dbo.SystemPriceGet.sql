...
GO
IF OBJECT_ID('[dbo].[SystemPriceGet]', 'FN') IS NULL EXEC('CREATE FUNCTION [dbo].[SystemPriceGet] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE FUNCTION [dbo].[SystemPriceGet]
(
	@SYSTEM	INT,
	@DISTR	INT,
	@DATE	VARCHAR(20)
