...
GO
IF OBJECT_ID('[dbo].[SYSTEM_PRICE_SET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_PRICE_SET]  AS SELECT 1')
GO
ALTER PROCEDURE [dbo].[SYSTEM_PRICE_SET]
	@DATA	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[SYSTEM_PRICE_SET] TO DBPrice;
GO
