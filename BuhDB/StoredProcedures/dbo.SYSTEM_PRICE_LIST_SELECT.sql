	...
	SELECT DISTINCT
		SystemFullName +
			CASE 
				...
				ELSE
					CASE @PSEDO 				
						WHEN 'ONLINE' THEN ' Онлайн версия'
						WHEN 'ONLINE2' THEN ' Онлайн-версия Пароль индивидуальный'
						WHEN 'ONLINE2_CLIENT' THEN ' Онлайн-версия Пароль индивидуальный'
						WHEN 'ONLINE3' THEN ' Онлайн-версия Ключ'
						WHEN 'ONLINE3_CLIENT' THEN ' Онлайн-версия Ключ'
						WHEN 'MOBILE' THEN ' Мобильная версия'
						WHEN 'ONLINE_EXP' THEN ' Онлайн-версия Пароль'
						WHEN 'ONLINE_EXP_CLIENT' THEN ' Онлайн-версия Пароль'
						WHEN 'OVM_1' THEN ' Онлайн-версия М (ОД 1)'
						WHEN 'OVM_1_CL' THEN ' Онлайн-версия М (ОД 1)' 
						WHEN 'OVM_2' THEN ' Онлайн-версия М (ОД 2)'
						WHEN 'OVM_2_CL' THEN ' Онлайн-версия М (ОД 2)'
						WHEN 'DEPO_ONLINE' THEN ' Онлайн версия'
						WHEN 'DEPO_ONLINE2' THEN ' Онлайн-версия Пароль индивидуальный'
						WHEN 'DEPO_ONLINE2_CLIENT' THEN ' Онлайн-версия Пароль индивидуальный'
						WHEN 'DEPO_ONLINE3' THEN ' Онлайн-версия Ключ'
						WHEN 'DEPO_ONLINE3_CLIENT' THEN ' Онлайн-версия Ключ'				
						WHEN 'DEPO_ONLINE_EXP' THEN ' Онлайн-версия Пароль'
						WHEN 'DEPO_ONLINE_EXP_CLIENT' THEN ' Онлайн-версия Пароль'
						WHEN 'DEPO_OVM_1' THEN ' Онлайн-версия М (ОД 1)'
						WHEN 'DEPO_OVM_1_CL' THEN ' Онлайн-версия М (ОД 1)' 
						WHEN 'DEPO_OVM_2' THEN ' Онлайн-версия М (ОД 2)'
						WHEN 'DEPO_OVM_2_CL' THEN ' Онлайн-версия М (ОД 2)'
						ELSE ''
					END 
				END AS SystemName, 
