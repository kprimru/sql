...
GO
IF OBJECT_ID('[dbo].[PRICE_IMPORT_CHECK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[PRICE_IMPORT_CHECK]  AS SELECT 1')
GO
ALTER PROCEDURE [dbo].[PRICE_IMPORT_CHECK]
	@DATA	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[PRICE_IMPORT_CHECK] TO DBPrice;
GO
