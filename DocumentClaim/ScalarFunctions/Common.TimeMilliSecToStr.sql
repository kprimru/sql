...
GO
IF OBJECT_ID('[Common].[TimeMilliSecToStr]', 'FN') IS NULL EXEC('CREATE FUNCTION [Common].[TimeMilliSecToStr] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE FUNCTION [Common].[TimeMilliSecToStr]
(
	@TIME BIGINT
)
