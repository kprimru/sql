...
GO
IF OBJECT_ID('[Common].[SETTINGS_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Common].[SETTINGS_GET]  AS SELECT 1')
GO
ALTER PROCEDURE [Common].[SETTINGS_GET]
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [Common].[SETTINGS_GET] TO public;
GO
