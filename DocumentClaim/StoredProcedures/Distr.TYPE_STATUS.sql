...
GO
IF OBJECT_ID('[Distr].[TYPE_STATUS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Distr].[TYPE_STATUS]  AS SELECT 1')
GO
ALTER PROCEDURE [Distr].[TYPE_STATUS]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [Distr].[TYPE_STATUS] TO rl_distr_type_h;
GO
