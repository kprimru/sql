...
GO
IF OBJECT_ID('[Claim].[VENDOR_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Claim].[VENDOR_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [Claim].[VENDOR_SELECT]
...
END
GO
GRANT EXECUTE ON [Claim].[VENDOR_SELECT] TO rl_vendor_r;
GO
