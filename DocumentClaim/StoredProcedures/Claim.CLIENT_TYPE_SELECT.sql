...
GO
IF OBJECT_ID('[Claim].[CLIENT_TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Claim].[CLIENT_TYPE_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [Claim].[CLIENT_TYPE_SELECT]
...
END
GO
GRANT EXECUTE ON [Claim].[CLIENT_TYPE_SELECT] TO rl_client_type_r;
GO
