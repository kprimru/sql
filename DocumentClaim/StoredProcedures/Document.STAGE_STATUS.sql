...
GO
IF OBJECT_ID('[Document].[STAGE_STATUS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Document].[STAGE_STATUS]  AS SELECT 1')
GO
ALTER PROCEDURE [Document].[STAGE_STATUS]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
GO
GRANT EXECUTE ON [Document].[STAGE_STATUS] TO rl_stage_h;
GO
