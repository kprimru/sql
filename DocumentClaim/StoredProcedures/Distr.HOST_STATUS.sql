...
GO
IF OBJECT_ID('[Distr].[HOST_STATUS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Distr].[HOST_STATUS]  AS SELECT 1')
GO
ALTER PROCEDURE [Distr].[HOST_STATUS]
	@ID		UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [Distr].[HOST_STATUS] TO rl_host_h;
GO
