...
GO
IF OBJECT_ID('[Claim].[TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Claim].[TYPE_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [Claim].[TYPE_SELECT]
...
END
GO
GRANT EXECUTE ON [Claim].[TYPE_SELECT] TO rl_document_type_r;
GO
