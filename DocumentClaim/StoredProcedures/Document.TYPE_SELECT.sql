...
GO
IF OBJECT_ID('[Document].[TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Document].[TYPE_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [Document].[TYPE_SELECT]
...
END
GO
GRANT EXECUTE ON [Document].[TYPE_SELECT] TO rl_doc_type_r;
GO
