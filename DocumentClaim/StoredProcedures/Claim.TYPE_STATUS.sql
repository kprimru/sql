...
GO
IF OBJECT_ID('[Claim].[TYPE_STATUS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Claim].[TYPE_STATUS]  AS SELECT 1')
GO
ALTER PROCEDURE [Claim].[TYPE_STATUS]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [Claim].[TYPE_STATUS] TO rl_document_type_h;
GO
