...
GO
IF OBJECT_ID('[Claim].[MONTH_BONUS_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Claim].[MONTH_BONUS_SELECT]  AS SELECT 1')
GO

ALTER PROCEDURE [Claim].[MONTH_BONUS_SELECT]
...
END
GO
GRANT EXECUTE ON [Claim].[MONTH_BONUS_SELECT] TO rl_month_bonus_r;
GO
