...
GO
IF OBJECT_ID('[Claim].[ACTION_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Claim].[ACTION_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [Claim].[ACTION_SELECT]
...
END
GO
GRANT EXECUTE ON [Claim].[ACTION_SELECT] TO rl_action_r;
GO
