...
GO
IF OBJECT_ID('[Distr].[NET_STATUS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Distr].[NET_STATUS]  AS SELECT 1')
GO
ALTER PROCEDURE [Distr].[NET_STATUS]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [Distr].[NET_STATUS] TO rl_net_h;
GO
