...
GO
IF OBJECT_ID('[Claim].[CLAIM_VERIFY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Claim].[CLAIM_VERIFY]  AS SELECT 1')
GO
ALTER PROCEDURE [Claim].[CLAIM_VERIFY]
	@ID		UNIQUEIDENTIFIER,
	@NOTE	NVARCHAR(MAX)
AS
BEGIN
				...
				FROM
					...
					CROSS JOIN
						(
							...
							WHERE a.RL_NAME = 'rl_claim_notify_verify'
...
END
GO
GRANT EXECUTE ON [Claim].[CLAIM_VERIFY] TO rl_claim_verify;
GO
