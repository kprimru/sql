...
GO
CREATE UNIQUE NONCLUSTERED INDEX [UQ_dbo.SystemTypeTable(SST_CAPTION)] ON [dbo].[SystemTypeTable] ([SST_CAPTION] ASC);
CREATE UNIQUE NONCLUSTERED INDEX [UQ_dbo.SystemTypeTable(SST_LST)] ON [dbo].[SystemTypeTable] ([SST_LST] ASC);
CREATE UNIQUE NONCLUSTERED INDEX [UQ_dbo.SystemTypeTable(SST_NAME)] ON [dbo].[SystemTypeTable] ([SST_NAME] ASC);
GO
