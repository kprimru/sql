...
CREATE NONCLUSTERED INDEX [IX_dbo.PeriodRegTable(REG_ID_SYSTEM,REG_DISTR_NUM,REG_COMP_NUM)+INCL] ON [dbo].[PeriodRegTable] ([REG_ID_SYSTEM] ASC, [REG_DISTR_NUM] ASC, [REG_COMP_NUM] ASC) INCLUDE ([REG_ID_PERIOD], [REG_MAIN], [REG_COMPLECT]);
