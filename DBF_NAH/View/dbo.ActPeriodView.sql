...
GO
IF OBJECT_ID('[dbo].[ActPeriodView]', 'V ') IS NULL EXEC('CREATE VIEW [dbo].[ActPeriodView]  AS SELECT 1')
GO
...
AS
	...
	*/
	...
	ORDER BY ROW_NUMBER() OVER(PARTITION BY ACT_ID ORDER BY PR_DATE DESC)GO
