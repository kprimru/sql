...
GO
IF OBJECT_ID('[dbo].[ActIXView]', 'V ') IS NULL EXEC('CREATE VIEW [dbo].[ActIXView]  AS SELECT 1')
GO
...
CREATE UNIQUE NONCLUSTERED INDEX [UX_dbo.ActIXView(ACT_ID_CLIENT,AD_ID_DISTR,PR_DATE)] ON [dbo].[ActIXView] ([ACT_ID_CLIENT] ASC, [AD_ID_DISTR] ASC, [PR_DATE] DESC);
GO
