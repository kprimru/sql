...
GO
IF OBJECT_ID('[Subhost].[SubhostPayGetDouble]', 'IF') IS NULL EXEC('CREATE FUNCTION [Subhost].[SubhostPayGetDouble] () RETURNS TABLE AS RETURN (SELECT [NULL] = NULL)')
GO
CREATE FUNCTION [Subhost].[SubhostPayGetDouble]
(
	@START		SMALLDATETIME,
	@END		SMALLDATETIME
)
