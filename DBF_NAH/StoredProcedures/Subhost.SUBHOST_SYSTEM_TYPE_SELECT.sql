...
GO
IF OBJECT_ID('[Subhost].[SUBHOST_SYSTEM_TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[SUBHOST_SYSTEM_TYPE_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [Subhost].[SUBHOST_SYSTEM_TYPE_SELECT]
AS
BEGIN
	SET NOCOUNT ON;
...
GO
GRANT EXECUTE ON [Subhost].[SUBHOST_SYSTEM_TYPE_SELECT] TO rl_subhost_calc;
GO
