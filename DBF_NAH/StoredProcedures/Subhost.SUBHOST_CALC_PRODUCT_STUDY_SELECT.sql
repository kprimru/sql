...
GO
IF OBJECT_ID('[Subhost].[SUBHOST_CALC_PRODUCT_STUDY_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[SUBHOST_CALC_PRODUCT_STUDY_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [Subhost].[SUBHOST_CALC_PRODUCT_STUDY_SELECT]
	@PR_ID	SMALLINT,
	@SH_ID	SMALLINT
AS
BEGIN
...
GO
GRANT EXECUTE ON [Subhost].[SUBHOST_CALC_PRODUCT_STUDY_SELECT] TO rl_subhost_calc;
GO
