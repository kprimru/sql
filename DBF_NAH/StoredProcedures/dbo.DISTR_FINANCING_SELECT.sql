...
GO
IF OBJECT_ID('[dbo].[DISTR_FINANCING_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[DISTR_FINANCING_SELECT]  AS SELECT 1')
GO
/*
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			T.COUR_NAME, DF_EXCHANGE, DF_END, DF_BEGIN, DF_EXPIRE,
			T.TO_NUM
