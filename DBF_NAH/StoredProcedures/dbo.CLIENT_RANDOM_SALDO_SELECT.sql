...
GO
IF OBJECT_ID('[dbo].[CLIENT_RANDOM_SALDO_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_RANDOM_SALDO_SELECT]  AS SELECT 1')
GO
/*
Автор:
Дата создания:  
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_RANDOM_SALDO_SELECT] TO rl_fin_r;
GO
