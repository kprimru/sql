...
GO
IF OBJECT_ID('[dbo].[INCOME_OUT_AUTO_CONVEY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[INCOME_OUT_AUTO_CONVEY]  AS SELECT 1')
GO
/*
...
GO
GRANT EXECUTE ON [dbo].[INCOME_OUT_AUTO_CONVEY] TO rl_income_w;
GO
