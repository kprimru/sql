...
GO
IF OBJECT_ID('[Subhost].[___SUBHOST_REPORT_CREATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[___SUBHOST_REPORT_CREATE]  AS SELECT 1')
GO
...
END
GO
GRANT EXECUTE ON [Subhost].[___SUBHOST_REPORT_CREATE] TO rl_subhost_calc;
GO
