...
GO
IF OBJECT_ID('[Ric].[STAGE_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Ric].[STAGE_GET]  AS SELECT 1')
GO
ALTER PROCEDURE [Ric].[STAGE_GET]
	@PR_ALG	SMALLINT,
	@PR_ID	SMALLINT
AS
BEGIN
...
GO
GRANT EXECUTE ON [Ric].[STAGE_GET] TO rl_ric_kbu;
GO
