...
GO
IF OBJECT_ID('[dbo].[REG_NODE_LOAD_FROM_DBF]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[REG_NODE_LOAD_FROM_DBF]  AS SELECT 1')
GO
...
BEGIN
	...
	INSERT INTO RegNodeTable
		...
		WHERE (RN_COMMENT LIKE '(А)%' OR RN_COMMENT LIKE '(Н1)%')
