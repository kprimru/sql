...
GO
IF OBJECT_ID('[dbo].[SUBHOST_DELIVERY_PRICE_TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SUBHOST_DELIVERY_PRICE_TYPE_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [dbo].[SUBHOST_DELIVERY_PRICE_TYPE_SELECT]
AS
BEGIN
	SET NOCOUNT ON;
