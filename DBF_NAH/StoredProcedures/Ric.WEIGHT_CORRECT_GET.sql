...
GO
IF OBJECT_ID('[Ric].[WEIGHT_CORRECT_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Ric].[WEIGHT_CORRECT_GET]  AS SELECT 1')
GO
ALTER PROCEDURE [Ric].[WEIGHT_CORRECT_GET]
	@PR_ALG	SMALLINT,
	@PR_ID	SMALLINT
AS
BEGIN
...
GO
GRANT EXECUTE ON [Ric].[WEIGHT_CORRECT_GET] TO rl_ric_kbu;
GO
