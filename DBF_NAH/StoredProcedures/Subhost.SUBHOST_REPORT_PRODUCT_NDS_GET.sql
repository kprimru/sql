...
GO
IF OBJECT_ID('[Subhost].[SUBHOST_REPORT_PRODUCT_NDS_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[SUBHOST_REPORT_PRODUCT_NDS_GET]  AS SELECT 1')
GO
ALTER PROCEDURE [Subhost].[SUBHOST_REPORT_PRODUCT_NDS_GET]
	@SH_ID	SMALLINT,
	@PR_MIN	SMALLINT,
	@PR_LIST	VARCHAR(MAX)
AS
