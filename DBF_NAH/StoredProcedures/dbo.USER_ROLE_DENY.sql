...
GO
IF OBJECT_ID('[dbo].[USER_ROLE_DENY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[USER_ROLE_DENY]  AS SELECT 1')
GO
...
ALTER PROCEDURE [dbo].[USER_ROLE_DENY]
	@user VARCHAR(100),
	@role VARCHAR(MAX)
AS
BEGIN
...
GO
GRANT EXECUTE ON [dbo].[USER_ROLE_DENY] TO rl_user;
GO
