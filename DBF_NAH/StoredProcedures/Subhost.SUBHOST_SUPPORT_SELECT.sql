...
GO
IF OBJECT_ID('[Subhost].[SUBHOST_SUPPORT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[SUBHOST_SUPPORT_SELECT]  AS SELECT 1')
GO
...
BEGIN
	...
	BEGIN TRY
		...
		IF (@PERIOD IN (252, 253)/* OR @PERIOD >= 356*/) AND @SUBHOST = 12
