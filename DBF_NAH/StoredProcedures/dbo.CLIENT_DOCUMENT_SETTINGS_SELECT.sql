...
GO
IF OBJECT_ID('[dbo].[CLIENT_DOCUMENT_SETTINGS_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DOCUMENT_SETTINGS_SELECT]  AS SELECT 1')
GO
/*
Автор:
Дата создания:  
...
GO
GRANT EXECUTE ON [dbo].[CLIENT_DOCUMENT_SETTINGS_SELECT] TO rl_client_r;
GO
