...
GO
IF OBJECT_ID('[Client].[COMPANY_CALL_DELETE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Client].[COMPANY_CALL_DELETE]  AS SELECT 1')
GO
ALTER PROCEDURE [Client].[COMPANY_CALL_DELETE]
	@ID			UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [Client].[COMPANY_CALL_DELETE] TO rl_call_d;
GO
