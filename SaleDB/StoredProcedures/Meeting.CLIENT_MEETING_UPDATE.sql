...
GO
IF OBJECT_ID('[Meeting].[CLIENT_MEETING_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Meeting].[CLIENT_MEETING_UPDATE]  AS SELECT 1')
GO
ALTER PROCEDURE [Meeting].[CLIENT_MEETING_UPDATE]
	@ID				UNIQUEIDENTIFIER,
...
GO
GRANT EXECUTE ON [Meeting].[CLIENT_MEETING_UPDATE] TO rl_meeting_result;
GO
