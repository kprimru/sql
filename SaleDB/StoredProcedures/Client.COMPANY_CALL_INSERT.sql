...
GO
IF OBJECT_ID('[Client].[COMPANY_CALL_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Client].[COMPANY_CALL_INSERT]  AS SELECT 1')
GO
ALTER PROCEDURE [Client].[COMPANY_CALL_INSERT]
...
END
GO
GRANT EXECUTE ON [Client].[COMPANY_CALL_INSERT] TO rl_call_w;
GO
