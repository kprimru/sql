...
GO
IF OBJECT_ID('[Client].[PAY_CATEGORY_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Client].[PAY_CATEGORY_INSERT]  AS SELECT 1')
GO
...
BEGIN
	...
	BEGIN TRY
		INSERT INTO Client.PayCategory(NAME, SHORT, GR, ORD)
			...
			SELECT @NAME, @SHORT, @GR, (SELECT MAX(ORD) FROM Client.PayCategory) + 10
