...
GO
IF OBJECT_ID('[Client].[COMPANY_ARCHIVE_APPLY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Client].[COMPANY_ARCHIVE_APPLY]  AS SELECT 1')
GO
ALTER PROCEDURE [Client].[COMPANY_ARCHIVE_APPLY]
	@ID				UNIQUEIDENTIFIER,
...
END
GO
GRANT EXECUTE ON [Client].[COMPANY_ARCHIVE_APPLY] TO rl_archive_apply;
GO
