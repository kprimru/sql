...
GO
IF OBJECT_ID('[Meeting].[CLIENT_MEETING_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Meeting].[CLIENT_MEETING_INSERT]  AS SELECT 1')
GO
ALTER PROCEDURE [Meeting].[CLIENT_MEETING_INSERT]
...
GO
GRANT EXECUTE ON [Meeting].[CLIENT_MEETING_INSERT] TO rl_meeting_result;
GO
