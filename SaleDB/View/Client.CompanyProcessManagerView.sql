...
GO
CREATE UNIQUE CLUSTERED INDEX [IX_CLUST] ON [Client].[CompanyProcessManagerView] ([ID] ASC);
CREATE NONCLUSTERED INDEX [IX_PERS] ON [Client].[CompanyProcessManagerView] ([ID_PERSONAL] ASC);
GO
