...
CREATE NONCLUSTERED INDEX [IX_Meeting.AssignedMeeting(ID_COMPANY,ID_ASSIGNER,EXPECTED_DATE,ID_STATUS)+INCL] ON [Meeting].[AssignedMeeting] ([ID_COMPANY] ASC, [ID_ASSIGNER] ASC, [EXPECTED_DATE] ASC, [ID_STATUS] ASC) INCLUDE ([ID], [ID_MASTER], [ID_PARENT], [STATUS]);
