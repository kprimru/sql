...
GO
IF OBJECT_ID('[dbo].[CLIENT_SPEC_FINANCING_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SPEC_FINANCING_SELECT]  AS SELECT 1')
GO
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_SPEC_FINANCING_SELECT] TO rl_client_fin_r;
GO
