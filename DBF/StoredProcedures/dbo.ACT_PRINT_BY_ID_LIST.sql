...
BEGIN
	...
	INSERT INTO #master (
		...
		SELECT
				...
				ISNULL((
					SELECT TOP 1 CK_HEADER
					FROM 
						dbo.ContractTable INNER JOIN	
						dbo.ContractDistrTable ON COD_ID_CONTRACT = CO_ID INNER JOIN
						dbo.ActDistrTable ON AD_ID_DISTR = COD_ID_DISTR AND AD_ID_ACT = A.ACT_ID INNER JOIN
		...
		FROM
			...
			OUTER APPLY
				(
					SELECT TOP 1 p.CO_ID, CO_NUM, CO_DATE, CK_HEADER, CK_FOOTER, CK_CENTER
					FROM 
						(
