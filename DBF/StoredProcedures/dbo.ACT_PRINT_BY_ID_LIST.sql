...
GO
IF OBJECT_ID('[dbo].[ACT_PRINT_BY_ID_LIST]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[ACT_PRINT_BY_ID_LIST]  AS SELECT 1')
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        (
			...
			ORG_DIR_POS				VarChar(50),
			ORG_FOUNDATION			VarChar(512),
			ORG_PROVIDE				VarChar(100),
            BA_NAME                 VarChar(150),
            PR_MONTH                VarChar(15),
		...
		INSERT INTO #master (
					...
					ORG_DIR_FAM, ORG_DIR_NAME, ORG_DIR_OTCH, ORG_DIR_SHORT, ORG_DIR_POS, ORG_FOUNDATION, ORG_PROVIDE,
					BA_NAME,
					PR_MONTH, PR_DATE,
		...
		IF @GROUP = 1
			SELECT
				...
				ORG_LORO, ORG_BIK, ORG_DIR_FAM, ORG_DIR_NAME, ORG_DIR_OTCH, ORG_DIR_SHORT, ORG_DIR_POS, ORG_FOUNDATION, ORG_PROVIDE,
		...
		--BEGIN
			...
			INSERT INTO dbo.ActFactDetailTable (
				AFD_ID_AFM,
				PR_ID, PR_DATE, PR_MONTH, PR_END_DATE,
				DIS_ID, DIS_NUM, SYS_NAME, SYS_ORDER, SYS_ADD,
				AD_PRICE, AD_TAX_PRICE, AD_TOTAL_PRICE,
				TX_PERCENT, TX_NAME,
				SO_ID, SO_BILL_STR, SO_INV_UNIT,
