...
GO
IF OBJECT_ID('[dbo].[INVOICE_CREATE_BY_CONSIGN]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[INVOICE_CREATE_BY_CONSIGN]  AS SELECT 1')
GO
/*
Автор:
Дата создания:  
	...
	BEGIN TRY
		...
		*/
					...
					(
						...
						INNER JOIN dbo.ConsignmentDetailTable ON CSD_ID_DISTR = COD_ID_DISTR AND CSD_ID_CONS = CSG_ID
