...
GO
IF OBJECT_ID('[dbo].[SUBHOST_DELIVERY_PRICE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SUBHOST_DELIVERY_PRICE_SELECT]  AS SELECT 1')
GO
