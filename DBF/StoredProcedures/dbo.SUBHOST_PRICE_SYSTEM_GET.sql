...
GO
IF OBJECT_ID('[dbo].[SUBHOST_PRICE_SYSTEM_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SUBHOST_PRICE_SYSTEM_GET]  AS SELECT 1')
GO
ALTER PROCEDURE [dbo].[SUBHOST_PRICE_SYSTEM_GET]
	@SPS_ID	INT
AS
BEGIN
	SET NOCOUNT ON;
