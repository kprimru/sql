...
GO
IF OBJECT_ID('[Subhost].[SUBHOST_YEAR_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[SUBHOST_YEAR_REPORT]  AS SELECT 1')
GO
ALTER PROCEDURE [Subhost].[SUBHOST_YEAR_REPORT]
	@PR_MIN	SMALLINT,
...
END
GO
GRANT EXECUTE ON [Subhost].[SUBHOST_YEAR_REPORT] TO rl_subhost_calc;
GO
