...
GO
IF OBJECT_ID('[dbo].[SALDO_RECALC]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SALDO_RECALC]  AS SELECT 1')
GO
/*
	...
	BEGIN TRY
		...
		*/
		...
		WHERE SaldoTable.SL_ID = a.SL_ID
			--AND SaldoTable.SL_DATE <> a.SL_DATE
			--AND SaldoTable.SL_REST <> a.SL_REST
