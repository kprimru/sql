...
GO
IF OBJECT_ID('[dbo].[INVOICE_CREATE_BY_ACT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[INVOICE_CREATE_BY_ACT]  AS SELECT 1')
GO
/*
Автор:
Дата создания:  
...
END
GO
GRANT EXECUTE ON [dbo].[INVOICE_CREATE_BY_ACT] TO rl_invoice_w;
GO
