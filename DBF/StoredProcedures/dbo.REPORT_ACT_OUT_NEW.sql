...
GO
IF OBJECT_ID('[dbo].[REPORT_ACT_OUT_NEW]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[REPORT_ACT_OUT_NEW]  AS SELECT 1')
GO
/*
Автор:
Дата создания:  
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
				...
				PR_ID, P.PR_DATE, a.DIS_ID, DIS_STR, BD_TOTAL_PRICE,
				ISNULL((
					SELECT SUM(ID_PRICE)
