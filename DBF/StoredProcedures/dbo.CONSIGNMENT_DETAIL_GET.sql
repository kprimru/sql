...
GO
IF OBJECT_ID('[dbo].[CONSIGNMENT_DETAIL_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CONSIGNMENT_DETAIL_GET]  AS SELECT 1')
GO
/*
Автор:
Дата создания:  
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			DIS_ID, DIS_STR, CSD_NUM, CSD_COST, CSD_PRICE, CSD_TAX_PRICE, CSD_TOTAL_PRICE,
