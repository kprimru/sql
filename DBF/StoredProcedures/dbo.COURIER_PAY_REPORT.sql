...
GO
IF OBJECT_ID('[dbo].[COURIER_PAY_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[COURIER_PAY_REPORT]  AS SELECT 1')
GO
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			[dbo].[MonthDateName](PAY_MONTH) + ' ' + CONVERT(VARCHAR(20), DATEPART(YEAR, PAY_MONTH)) AS PAY_MONTH_STR,
