...
GO
IF OBJECT_ID('[Kladr].[KLADR_RELOAD_OLD]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Kladr].[KLADR_RELOAD_OLD]  AS SELECT 1')
GO
ALTER PROCEDURE [Kladr].[KLADR_RELOAD_OLD]
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [Kladr].[KLADR_RELOAD_OLD] TO rl_kladr_w;
GO
