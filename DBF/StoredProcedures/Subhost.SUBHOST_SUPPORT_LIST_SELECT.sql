...
GO
IF OBJECT_ID('[Subhost].[SUBHOST_SUPPORT_LIST_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[SUBHOST_SUPPORT_LIST_SELECT]  AS SELECT 1')
GO
ALTER PROCEDURE [Subhost].[SUBHOST_SUPPORT_LIST_SELECT]
	@PERIOD	INT,
	@SUBHOST SMALLINT
AS
BEGIN
