...
GO
IF OBJECT_ID('[dbo].[COURIER_PAY_CALC]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[COURIER_PAY_CALC]  AS SELECT 1')
GO
ALTER PROCEDURE [dbo].[COURIER_PAY_CALC]
...
END
GO
GRANT EXECUTE ON [dbo].[COURIER_PAY_CALC] TO rl_courier_pay;
GO
