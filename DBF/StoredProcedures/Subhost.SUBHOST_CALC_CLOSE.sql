...
GO
IF OBJECT_ID('[Subhost].[SUBHOST_CALC_CLOSE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[SUBHOST_CALC_CLOSE]  AS SELECT 1')
GO
ALTER PROCEDURE [Subhost].[SUBHOST_CALC_CLOSE]
	@SH_ID				SMALLINT,
	@PR_ID				SMALLINT,
...
END
GO
GRANT EXECUTE ON [Subhost].[SUBHOST_CALC_CLOSE] TO rl_subhost_calc;
GO
