...
GO
IF OBJECT_ID('[dbo].[REPORT_SUBHOST_KBU]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[REPORT_SUBHOST_KBU]  AS SELECT 1')
GO
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			[dbo].[MonthDateName](PR_DATE) + ' ' + CONVERT(VARCHAR(20), DATEPART(YEAR, PR_DATE)) AS PR_NAME,
