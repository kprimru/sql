...
GO
IF OBJECT_ID('[Subhost].[SUBHOST_CALC_PRODUCT_STUDY_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[SUBHOST_CALC_PRODUCT_STUDY_GET]  AS SELECT 1')
GO
ALTER PROCEDURE [Subhost].[SUBHOST_CALC_PRODUCT_STUDY_GET]
	@PR_ID	SMALLINT,
	@SH_ID	SMALLINT,
	@HIDE	BIT = 0
AS
...
END
GO
GRANT EXECUTE ON [Subhost].[SUBHOST_CALC_PRODUCT_STUDY_GET] TO rl_subhost_calc;
GO
