...
AS
SELECT
		CL_ID, CL_PSEDO, CL_FULL_NAME, CL_SHORT_NAME, CO_NUM, CO_DATE, PR_DATE, PR_ID, PR_END_DATE, [dbo].[MonthDateName](PR_DATE) AS PR_MONTH, Cast(DatePart(Year, PR_DATE) AS VarChar(100)) AS PR_YEAR,
