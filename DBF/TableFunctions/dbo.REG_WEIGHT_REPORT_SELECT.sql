...
GO
IF OBJECT_ID('[dbo].[REG_WEIGHT_REPORT_SELECT]', 'TF') IS NULL EXEC('CREATE FUNCTION [dbo].[REG_WEIGHT_REPORT_SELECT] () RETURNS @output TABLE(Id Int) AS BEGIN RETURN END')
GO
