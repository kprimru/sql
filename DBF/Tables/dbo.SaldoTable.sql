...
(
        ...
        CONSTRAINT [PK_dbo.SaldoTable] PRIMARY KEY CLUSTERED ([SL_ID]),
...
GO
CREATE NONCLUSTERED INDEX [IX_dbo.SaldoTable(SL_ID_ACT_DIS)+(SL_ID_CLIENT,SL_ID_DISTR,SL_REST)] ON [dbo].[SaldoTable] ([SL_ID_ACT_DIS] ASC) INCLUDE ([SL_ID_CLIENT], [SL_ID_DISTR], [SL_REST]);
CREATE NONCLUSTERED INDEX [IX_dbo.SaldoTable(SL_ID_BILL_DIS)+(SL_ID_CLIENT,SL_ID_DISTR,SL_REST)] ON [dbo].[SaldoTable] ([SL_ID_BILL_DIS] ASC) INCLUDE ([SL_ID_CLIENT], [SL_ID_DISTR], [SL_REST]);
CREATE NONCLUSTERED INDEX [IX_dbo.SaldoTable(SL_ID_CLIENT)] ON [dbo].[SaldoTable] ([SL_ID_CLIENT] ASC);
CREATE NONCLUSTERED INDEX [IX_dbo.SaldoTable(SL_ID_DISTR,SL_DATE)+(SL_ID_CLIENT,SL_REST,SL_TP)] ON [dbo].[SaldoTable] ([SL_ID_DISTR] ASC, [SL_DATE] ASC) INCLUDE ([SL_ID_CLIENT], [SL_REST], [SL_TP]);
CREATE NONCLUSTERED INDEX [IX_dbo.SaldoTable(SL_ID_IN_DIS)+(SL_ID_CLIENT,SL_ID_DISTR,SL_REST)] ON [dbo].[SaldoTable] ([SL_ID_IN_DIS] ASC) INCLUDE ([SL_ID_CLIENT], [SL_ID_DISTR], [SL_REST]);
GO
