...
CREATE NONCLUSTERED INDEX [IX_dbo.PeriodRegTable(REG_ID_PERIOD,REG_ID_HOST)+INCL] ON [dbo].[PeriodRegTable] ([REG_ID_PERIOD] ASC, [REG_ID_HOST] ASC) INCLUDE ([REG_ID], [REG_ID_SYSTEM], [REG_DISTR_NUM], [REG_COMP_NUM], [REG_ID_TYPE], [REG_ID_NET], [REG_ID_STATUS], [REG_ID_TECH_TYPE], [REG_COMMENT], [REG_COMPLECT]);
...
CREATE NONCLUSTERED INDEX [IX_dbo.PeriodRegTable(REG_ID_PERIOD,REG_ID_SYSTEM,REG_ID_TYPE,REG_ID_NET,REG_ID_STATUS)] ON [dbo].[PeriodRegTable] ([REG_ID_PERIOD] ASC, [REG_ID_SYSTEM] ASC, [REG_ID_TYPE] ASC, [REG_ID_NET] ASC, [REG_ID_STATUS] ASC);
