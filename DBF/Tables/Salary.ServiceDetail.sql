...
GO
CREATE NONCLUSTERED INDEX [IX_Salary.ServiceDetail(ID_CLIENT,ID_PERIOD)+(CLIENT_TOTAL_PRICE,TO_COUNT)] ON [Salary].[ServiceDetail] ([ID_CLIENT] ASC, [ID_PERIOD] ASC) INCLUDE ([CLIENT_TOTAL_PRICE], [TO_COUNT]);
