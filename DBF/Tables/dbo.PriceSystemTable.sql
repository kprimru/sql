...
GO
CREATE UNIQUE CLUSTERED INDEX [UQ_dbo.PriceSystemTable(PS_ID_PERIOD,PS_ID_SYSTEM,PS_ID_TYPE,PS_ID_PGD)] ON [dbo].[PriceSystemTable] ([PS_ID_PERIOD] ASC, [PS_ID_SYSTEM] ASC, [PS_ID_TYPE] ASC, [PS_ID_PGD] ASC);
