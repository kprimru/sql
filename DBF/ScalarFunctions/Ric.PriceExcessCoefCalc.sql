...
GO
IF OBJECT_ID('[Ric].[PriceExcessCoefCalc]', 'FN') IS NULL EXEC('CREATE FUNCTION [Ric].[PriceExcessCoefCalc] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE FUNCTION [Ric].[PriceExcessCoefCalc]
(
	@PR_ALG	SMALLINT,
	@PR_ID	SMALLINT
)
