...
GO
IF OBJECT_ID('[Ric].[PriceExcessCoefGet]', 'FN') IS NULL EXEC('CREATE FUNCTION [Ric].[PriceExcessCoefGet] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE FUNCTION [Ric].[PriceExcessCoefGet]
(
	@PR_ALG	SMALLINT,
	@EXCESS	DECIMAL(10, 4)
)
