...
GO
IF OBJECT_ID('[dbo].[IncomeSystemString]', 'FN') IS NULL EXEC('CREATE FUNCTION [dbo].[IncomeSystemString] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE FUNCTION [dbo].[IncomeSystemString]
(
	@CL_ID	INT,
