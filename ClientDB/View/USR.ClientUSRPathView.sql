...
GO
IF OBJECT_ID('[USR].[ClientUSRPathView]', 'V ') IS NULL EXEC('CREATE VIEW [USR].[ClientUSRPathView]  AS SELECT 1')
GO
CREATE OR ALTER VIEW [USR].[ClientUSRPathView]
AS
	...
	GROUP BY UD_ID_CLIENT, UF_PATHGO
