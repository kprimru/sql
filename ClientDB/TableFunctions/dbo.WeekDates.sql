...
GO
IF OBJECT_ID('[dbo].[WeekDates]', 'TF') IS NULL EXEC('CREATE FUNCTION [dbo].[WeekDates] () RETURNS @output TABLE(Id Int) AS BEGIN RETURN END')
GO
CREATE OR ALTER FUNCTION [dbo].[WeekDates]
(
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME
)
