...
GO
IF OBJECT_ID('[dbo].[GET_TABLE_FROM_LIST]', 'TF') IS NULL EXEC('CREATE FUNCTION [dbo].[GET_TABLE_FROM_LIST] () RETURNS @output TABLE(Id Int) AS BEGIN RETURN END')
GO
CREATE OR ALTER FUNCTION [dbo].[GET_TABLE_FROM_LIST](@List VARCHAR(MAX), @Delimiter VARCHAR(10)=',')
