...
GO
IF OBJECT_ID('[Common].[NumToStr]', 'FN') IS NULL EXEC('CREATE FUNCTION [Common].[NumToStr] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE OR ALTER FUNCTION [Common].[NumToStr]
(
	@NUM			BIGINT,
	@IS_MALE_GENDER	BIT
)
