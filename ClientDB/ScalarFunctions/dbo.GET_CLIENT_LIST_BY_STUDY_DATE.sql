...
GO
IF OBJECT_ID('[dbo].[GET_CLIENT_LIST_BY_STUDY_DATE]', 'FN') IS NULL EXEC('CREATE FUNCTION [dbo].[GET_CLIENT_LIST_BY_STUDY_DATE] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE OR ALTER FUNCTION [dbo].[GET_CLIENT_LIST_BY_STUDY_DATE]
(
