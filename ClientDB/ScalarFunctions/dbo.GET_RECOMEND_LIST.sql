...
GO
IF OBJECT_ID('[dbo].[GET_RECOMEND_LIST]', 'FN') IS NULL EXEC('CREATE FUNCTION [dbo].[GET_RECOMEND_LIST] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE OR ALTER FUNCTION [dbo].[GET_RECOMEND_LIST]
(
