...
GO
IF OBJECT_ID('[dbo].[PhoneString]', 'FN') IS NULL EXEC('CREATE FUNCTION [dbo].[PhoneString] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE OR ALTER FUNCTION [dbo].[PhoneString]
(
	@PHONE VARCHAR(512)
)
RETURNS VARCHAR(256)
