...
GO
IF OBJECT_ID('[dbo].[SubhostByComment]', 'FN') IS NULL EXEC('CREATE FUNCTION [dbo].[SubhostByComment] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE OR ALTER FUNCTION [dbo].[SubhostByComment]
(
	@COMMENT	VARCHAR(200),
	@DISTR		INT
)
