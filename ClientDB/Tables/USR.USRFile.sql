...
CREATE NONCLUSTERED INDEX [IX_USR.USRFile(UF_ID_COMPLECT,UF_PATH,UF_MAX_DATE)+(UF_ID,UF_CREATE,UF_ID_KIND,UF_UPTIME,UF_ACTIVE,UF_NAME)] ON [USR].[USRFile] ([UF_ID_COMPLECT] ASC, [UF_PATH] ASC, [UF_MAX_DATE] ASC) INCLUDE ([UF_ID], [UF_CREATE], [UF_ID_KIND], [UF_UPTIME], [UF_ACTIVE], [UF_NAME]);
