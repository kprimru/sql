...
GO
CREATE NONCLUSTERED INDEX [IX_dbo.OnlineActivity(ID_HOST,DISTR,COMP)+(ID_WEEK,LGN,ACTIVITY)] ON [dbo].[OnlineActivity] ([ID_HOST] ASC, [DISTR] ASC, [COMP] ASC) INCLUDE ([ID_WEEK], [LGN], [ACTIVITY], [LOGIN_CNT], [SESSION_TIME]);
