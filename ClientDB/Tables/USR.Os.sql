...
GO
CREATE NONCLUSTERED INDEX [IX_USR.Os(OS_NAME)+(OS_ID,OS_MIN,OS_MAJ,OS_BUILD,OS_PLATFORM,OS_EDITION,OS_CAPACITY,OS_LANG,OS_COMPATIBILITY)] ON [USR].[Os] ([OS_NAME] ASC) INCLUDE ([OS_ID], [OS_MIN], [OS_MAJ], [OS_BUILD], [OS_PLATFORM], [OS_EDITION], [OS_CAPACITY], [OS_LANG], [OS_COMPATIBILITY]);
GO
