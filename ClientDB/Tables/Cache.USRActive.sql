...
GO
CREATE NONCLUSTERED INDEX [IX_Cache.USRActive(UD_DISTR,UD_ID_HOST,UD_COMP)+(UF_ID)] ON [Cache].[USRActive] ([UD_DISTR] ASC, [UD_ID_HOST] ASC, [UD_COMP] ASC) INCLUDE ([UF_ID]);
