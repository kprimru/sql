...
CREATE NONCLUSTERED INDEX [IX_Reg.RegHistory(ID_SYSTEM)+INCL] ON [Reg].[RegHistory] ([ID_SYSTEM] ASC) INCLUDE ([ID], [ID_DISTR], [DATE], [ID_NET], [ID_TYPE], [SUBHOST], [TRAN_COUNT], [TRAN_LEFT], [ID_STATUS], [REG_DATE], [FIRST_REG], [COMPLECT], [COMMENT]);
GO
