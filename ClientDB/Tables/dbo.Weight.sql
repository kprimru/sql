...
(
        ...
        CONSTRAINT [FK_dbo.Weight(NetType_Id)_dbo.NetType(NT_ID)] FOREIGN KEY  ([NetType_Id]) REFERENCES [Din].[NetType] ([NT_ID]),
        CONSTRAINT [FK_dbo.Weight(System_Id)_dbo.SystemTable(SystemID)] FOREIGN KEY  ([System_Id]) REFERENCES [dbo].[SystemTable] ([SystemID]),
        CONSTRAINT [FK_dbo.Weight(SystemType_Id)_dbo.SystemType(SST_ID)] FOREIGN KEY  ([SystemType_Id]) REFERENCES [Din].[SystemType] ([SST_ID])
);
GO
