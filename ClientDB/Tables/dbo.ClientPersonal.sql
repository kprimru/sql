...
GO
CREATE NONCLUSTERED INDEX [IX_dbo.ClientPersonal(CP_ID_CLIENT)+(CP_ID_TYPE,CP_SURNAME,CP_NAME,CP_PATRON,CP_POS,CP_NOTE,CP_EMAIL,CP_PHONE,CP_PHONE_S,CP_FAX)] ON [dbo].[ClientPersonal] ([CP_ID_CLIENT] ASC) INCLUDE ([CP_ID_TYPE], [CP_SURNAME], [CP_NAME], [CP_PATRON], [CP_POS], [CP_NOTE], [CP_EMAIL], [CP_PHONE], [CP_PHONE_S], [CP_FAX]);
