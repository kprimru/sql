...
GO
CREATE NONCLUSTERED INDEX [IX_dbo.ClientStudy(ID_CLIENT,STATUS,DATE)+(UPD_DATE)] ON [dbo].[ClientStudy] ([ID_CLIENT] ASC, [STATUS] ASC, [DATE] ASC) INCLUDE ([UPD_DATE]);
CREATE NONCLUSTERED INDEX [IX_dbo.ClientStudy(ID_MASTER,UPD_DATE)] ON [dbo].[ClientStudy] ([ID_MASTER] ASC, [UPD_DATE] ASC);
