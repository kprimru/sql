...
(
        ...
        CONSTRAINT [FK_Price.CommercialOfferDetail(ID_NEW_SYSTEM)_dbo.SystemTable(SystemID)] FOREIGN KEY  ([ID_NEW_SYSTEM]) REFERENCES [dbo].[SystemTable] ([SystemID]),
        CONSTRAINT [FK_Price.CommercialOfferDetail(ID_OLD_SYSTEM)_dbo.SystemTable(SystemID)] FOREIGN KEY  ([ID_OLD_SYSTEM]) REFERENCES [dbo].[SystemTable] ([SystemID]),
        CONSTRAINT [FK_Price.CommercialOfferDetail(ID_SYSTEM)_dbo.SystemTable(SystemID)] FOREIGN KEY  ([ID_SYSTEM]) REFERENCES [dbo].[SystemTable] ([SystemID]),
        ...
        CONSTRAINT [FK_Price.CommercialOfferDetail(ID_NET)_dbo.DistrTypeTable(DistrTypeID)] FOREIGN KEY  ([ID_NET]) REFERENCES [dbo].[DistrTypeTable] ([DistrTypeID]),
        CONSTRAINT [FK_Price.CommercialOfferDetail(ID_NEW_NET)_dbo.DistrTypeTable(DistrTypeID)] FOREIGN KEY  ([ID_NEW_NET]) REFERENCES [dbo].[DistrTypeTable] ([DistrTypeID]),
        CONSTRAINT [FK_Price.CommercialOfferDetail(ID_OLD_NET)_dbo.DistrTypeTable(DistrTypeID)] FOREIGN KEY  ([ID_OLD_NET]) REFERENCES [dbo].[DistrTypeTable] ([DistrTypeID]),
        CONSTRAINT [FK_Price.CommercialOfferDetail(ID_TAX)_Common.Tax(ID)] FOREIGN KEY  ([ID_TAX]) REFERENCES [Common].[Tax] ([ID]),
        CONSTRAINT [FK_Price.CommercialOfferDetail(ID_PERIOD)_Common.Period(ID)] FOREIGN KEY  ([ID_PERIOD]) REFERENCES [Common].[Period] ([ID]),
