...
GO
CREATE CLUSTERED INDEX [IX_dbo.ClientContact(ID_CLIENT,STATUS,DATE)+(ID,PERSONAL,NOTE,ID_TYPE)] ON [dbo].[ClientContact] ([ID_CLIENT] ASC, [STATUS] ASC, [DATE] ASC);
...
CREATE NONCLUSTERED INDEX [IX_ID] ON [dbo].[ClientContact] ([ID] ASC, [UPD_DATE] ASC) INCLUDE ([UPD_USER]);
CREATE NONCLUSTERED INDEX [IX_MASTER] ON [dbo].[ClientContact] ([ID_MASTER] ASC, [UPD_DATE] ASC) INCLUDE ([UPD_USER]);
GO
