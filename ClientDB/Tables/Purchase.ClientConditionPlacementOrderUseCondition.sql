...
(
        ...
        CONSTRAINT [FK_Purchase.ClientConditionPlacementOrderUseCondition(ID_CPO)_Purchase.ClientConditionPlacementOrder(CPO_ID)] FOREIGN KEY  ([ID_CPO]) REFERENCES [Purchase].[ClientConditionPlacementOrder] ([CPO_ID])
);
GO
