...
GO
CREATE NONCLUSTERED INDEX [IX_dbo.RegProtocol(RPR_DATE)+INCL] ON [dbo].[RegProtocol] ([RPR_DATE] ASC) INCLUDE ([RPR_ID_HOST], [RPR_DISTR], [RPR_COMP], [RPR_OPER], [RPR_TYPE], [RPR_TEXT], [RPR_USER], [RPR_COMPUTER], [RPR_INSERT]);
...
CREATE NONCLUSTERED INDEX [IX_dbo.RegProtocol(RPR_OPER,RPR_DATE_S)+INCL] ON [dbo].[RegProtocol] ([RPR_OPER] ASC, [RPR_DATE_S] ASC) INCLUDE ([RPR_ID], [RPR_DATE], [RPR_ID_HOST], [RPR_DISTR], [RPR_COMP], [RPR_REG], [RPR_TYPE], [RPR_TEXT], [RPR_USER], [RPR_COMPUTER], [RPR_INSERT]);
GO
