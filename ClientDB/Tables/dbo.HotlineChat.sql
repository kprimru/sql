...
GO
CREATE NONCLUSTERED INDEX [IX_dbo.HotlineChat(DISTR,SYS,COMP)+(ID,FIRST_DATE,START,FINISH,PROFILE,FIO,EMAIL,PHONE,CHAT,LGN,RIC_PERSONAL,LINKS)] ON [dbo].[HotlineChat] ([DISTR] ASC, [SYS] ASC, [COMP] ASC) INCLUDE ([ID], [FIRST_DATE], [START], [FINISH], [PROFILE], [FIO], [EMAIL], [PHONE], [CHAT], [LGN], [RIC_PERSONAL], [LINKS]);
GO
