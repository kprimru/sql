...
GO
IF OBJECT_ID('[Maintenance].[PROC_JOURNAL_SIZE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[PROC_JOURNAL_SIZE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[PROC_JOURNAL_SIZE_SELECT]
