...
GO
IF OBJECT_ID('[Report].[HOTLINE_CONNECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[HOTLINE_CONNECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[HOTLINE_CONNECT]
