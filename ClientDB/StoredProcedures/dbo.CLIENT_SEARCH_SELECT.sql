...
GO
IF OBJECT_ID('[dbo].[CLIENT_SEARCH_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SEARCH_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SEARCH_SELECT]
	@CLIENTID	INT,
	@BEGIN		DATETIME = NULL,
	@END		DATETIME = NULL,
