...
GO
IF OBJECT_ID('[Control].[CONTROL_GROUP_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Control].[CONTROL_GROUP_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Control].[CONTROL_GROUP_SELECT]
