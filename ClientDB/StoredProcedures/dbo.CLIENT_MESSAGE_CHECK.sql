...
GO
IF OBJECT_ID('[dbo].[CLIENT_MESSAGE_CHECK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_MESSAGE_CHECK]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_MESSAGE_CHECK]
	@RES	TINYINT OUTPUT
AS
BEGIN
	SET NOCOUNT ON;
