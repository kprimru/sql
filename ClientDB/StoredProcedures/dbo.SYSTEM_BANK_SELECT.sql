...
GO
IF OBJECT_ID('[dbo].[SYSTEM_BANK_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_BANK_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_BANK_SELECT]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
