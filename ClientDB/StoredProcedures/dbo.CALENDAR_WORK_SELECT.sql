...
GO
IF OBJECT_ID('[dbo].[CALENDAR_WORK_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CALENDAR_WORK_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CALENDAR_WORK_SELECT]
