...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_DISCONNECT_LIST]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_DISCONNECT_LIST]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_DISCONNECT_LIST]
	@ID		UNIQUEIDENTIFIER,
