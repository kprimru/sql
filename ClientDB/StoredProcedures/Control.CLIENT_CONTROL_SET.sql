...
GO
IF OBJECT_ID('[Control].[CLIENT_CONTROL_SET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Control].[CLIENT_CONTROL_SET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Control].[CLIENT_CONTROL_SET]
	@CLIENT		INT,
	@NOTE		NVARCHAR(MAX),
