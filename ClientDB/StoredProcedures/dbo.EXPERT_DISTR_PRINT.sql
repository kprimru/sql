...
GO
IF OBJECT_ID('[dbo].[EXPERT_DISTR_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[EXPERT_DISTR_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[EXPERT_DISTR_PRINT]
	@NAME			NVARCHAR(128),
	@DISTR			INT,
	@SERVICE		INT
AS
...
END
GO
GRANT EXECUTE ON [dbo].[EXPERT_DISTR_PRINT] TO rl_expert_distr;
GO
