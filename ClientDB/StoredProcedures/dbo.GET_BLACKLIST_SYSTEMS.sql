...
CREATE OR ALTER PROCEDURE [dbo].[GET_BLACKLIST_SYSTEMS]
@DISTR INT = NULL,
@SYSID INT = NULL,
@P_DEL INT
...
END
GO
GRANT EXECUTE ON [dbo].[GET_BLACKLIST_SYSTEMS] TO BL_ADMIN;
GRANT EXECUTE ON [dbo].[GET_BLACKLIST_SYSTEMS] TO BL_EDITOR;
GRANT EXECUTE ON [dbo].[GET_BLACKLIST_SYSTEMS] TO BL_PARAM;
GRANT EXECUTE ON [dbo].[GET_BLACKLIST_SYSTEMS] TO BL_READER;
GRANT EXECUTE ON [dbo].[GET_BLACKLIST_SYSTEMS] TO BL_RGT;
GO
