...
GO
IF OBJECT_ID('[Salary].[SERVICE_WEIGHT_BALANS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[SERVICE_WEIGHT_BALANS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Salary].[SERVICE_WEIGHT_BALANS]
	@SERVICE		INT,
