...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISCONNECT_SALE_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISCONNECT_SALE_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISCONNECT_SALE_FILTER]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME
AS
BEGIN
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_DISCONNECT_SALE_FILTER] TO rl_disconnect_filter;
GO
