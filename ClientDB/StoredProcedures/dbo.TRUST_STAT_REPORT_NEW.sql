...
GO
IF OBJECT_ID('[dbo].[TRUST_STAT_REPORT_NEW]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[TRUST_STAT_REPORT_NEW]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[TRUST_STAT_REPORT_NEW]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SERVICE	INT,
	@MANAGER	INT
