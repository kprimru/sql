...
GO
IF OBJECT_ID('[Purchase].[TALK_HISTORY_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[TALK_HISTORY_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[TALK_HISTORY_INSERT]
	@CLIENT	INT,
	@DATE	SMALLDATETIME,
	@WHO	VARCHAR(150),
	@PERS	VARCHAR(150),
