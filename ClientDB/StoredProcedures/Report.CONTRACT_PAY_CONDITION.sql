...
GO
IF OBJECT_ID('[Report].[CONTRACT_PAY_CONDITION]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[CONTRACT_PAY_CONDITION]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[CONTRACT_PAY_CONDITION]
