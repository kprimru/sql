...
GO
IF OBJECT_ID('[dbo].[CLIENT_SEARCH_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SEARCH_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SEARCH_REPORT]
	--@STATMONTH INT,
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
    @MANAGERID	INT = NULL,
