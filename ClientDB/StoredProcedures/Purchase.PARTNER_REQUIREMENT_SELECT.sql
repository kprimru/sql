...
GO
IF OBJECT_ID('[Purchase].[PARTNER_REQUIREMENT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[PARTNER_REQUIREMENT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[PARTNER_REQUIREMENT_SELECT]
