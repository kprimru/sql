...
GO
IF OBJECT_ID('[dbo].[CALENDAR_WORK_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CALENDAR_WORK_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CALENDAR_WORK_SAVE]
	@ID		UNIQUEIDENTIFIER,
	@DATE	SMALLDATETIME,
	@TP		UNIQUEIDENTIFIER,
	@NAME	NVARCHAR(256),
