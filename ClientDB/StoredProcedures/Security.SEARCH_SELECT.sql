...
GO
IF OBJECT_ID('[Security].[SEARCH_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Security].[SEARCH_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Security].[SEARCH_SELECT]
	@TYPE	NVARCHAR(64)
AS
BEGIN
	SET NOCOUNT ON;
