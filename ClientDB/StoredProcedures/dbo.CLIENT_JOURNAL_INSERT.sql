...
GO
IF OBJECT_ID('[dbo].[CLIENT_JOURNAL_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_JOURNAL_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_JOURNAL_INSERT]
	@CLIENT		INT,
