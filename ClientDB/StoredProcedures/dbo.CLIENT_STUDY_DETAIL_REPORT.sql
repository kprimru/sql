...
GO
IF OBJECT_ID('[dbo].[CLIENT_STUDY_DETAIL_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_STUDY_DETAIL_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_STUDY_DETAIL_REPORT]
	@START		SMALLDATETIME,
