...
GO
IF OBJECT_ID('[dbo].[SERVICE_TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_TYPE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_TYPE_SELECT]
