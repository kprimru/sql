...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_HISTORY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_HISTORY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_HISTORY]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON
