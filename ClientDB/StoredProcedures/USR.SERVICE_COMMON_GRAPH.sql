...
GO
IF OBJECT_ID('[USR].[SERVICE_COMMON_GRAPH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[SERVICE_COMMON_GRAPH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[SERVICE_COMMON_GRAPH]
	@SERVICE	INT,
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
