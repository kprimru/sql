...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_CONNECT_DATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_CONNECT_DATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_CONNECT_DATE]
	@ID		UNIQUEIDENTIFIER,
