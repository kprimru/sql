...
GO
IF OBJECT_ID('[Report].[ZVE_SUBHOST_EXTENDED]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[ZVE_SUBHOST_EXTENDED]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[ZVE_SUBHOST_EXTENDED]
