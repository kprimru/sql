...
GO
IF OBJECT_ID('[Subhost].[TEST_AUDIT_CHECK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[TEST_AUDIT_CHECK]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Subhost].[TEST_AUDIT_CHECK]
