...
GO
IF OBJECT_ID('[dbo].[CLIENT_STUDY_CLAIM_MEETING_REPORT_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_STUDY_CLAIM_MEETING_REPORT_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_STUDY_CLAIM_MEETING_REPORT_PRINT]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME
AS
BEGIN
