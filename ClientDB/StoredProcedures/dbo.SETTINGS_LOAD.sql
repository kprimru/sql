...
GO
IF OBJECT_ID('[dbo].[SETTINGS_LOAD]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SETTINGS_LOAD]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SETTINGS_LOAD]
AS
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN TRY
		...
		IF NOT EXISTS
			...
			SELECT
				...
				ST_EXCEL_LONG_STRINGS, ST_FONT_SIZE, ST_CLOSE_QUERY,
