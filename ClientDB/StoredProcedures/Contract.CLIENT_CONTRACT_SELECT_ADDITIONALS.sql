...
GO
IF OBJECT_ID('[Contract].[CLIENT_CONTRACT_SELECT_ADDITIONALS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Contract].[CLIENT_CONTRACT_SELECT_ADDITIONALS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Contract].[CLIENT_CONTRACT_SELECT_ADDITIONALS]
