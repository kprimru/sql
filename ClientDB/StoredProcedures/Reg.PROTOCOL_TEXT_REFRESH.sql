...
GO
IF OBJECT_ID('[Reg].[PROTOCOL_TEXT_REFRESH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Reg].[PROTOCOL_TEXT_REFRESH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Reg].[PROTOCOL_TEXT_REFRESH]
