...
GO
IF OBJECT_ID('[dbo].[STUDY_VISIT_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_VISIT_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_VISIT_FILTER]
	@TEACHER	INT,
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@CLIENT		NVARCHAR(256)
