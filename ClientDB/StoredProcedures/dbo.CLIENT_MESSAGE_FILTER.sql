...
GO
IF OBJECT_ID('[dbo].[CLIENT_MESSAGE_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_MESSAGE_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_MESSAGE_FILTER]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SENDER		NVARCHAR(128),
