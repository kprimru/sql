...
GO
IF OBJECT_ID('[Maintenance].[BACKUP_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[BACKUP_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[BACKUP_SELECT]
AS
BEGIN
	SET NOCOUNT ON;
