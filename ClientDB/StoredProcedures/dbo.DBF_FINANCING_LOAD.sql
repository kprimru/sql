...
GO
IF OBJECT_ID('[dbo].[DBF_FINANCING_LOAD]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[DBF_FINANCING_LOAD]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[DBF_FINANCING_LOAD]
	@DATA	NVARCHAR(MAX)
...
END
GO
GRANT EXECUTE ON [dbo].[DBF_FINANCING_LOAD] TO rl_import_data;
GO
