...
GO
IF OBJECT_ID('[Cache].[CLIENT_CACHE_REFRESH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Cache].[CLIENT_CACHE_REFRESH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Cache].[CLIENT_CACHE_REFRESH]
	@Client_Id	Int				= NULL
AS
BEGIN
	SET NOCOUNT ON;
