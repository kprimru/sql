...
GO
IF OBJECT_ID('[dbo].[CLIENT_KIND_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_KIND_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_KIND_SELECT]
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_KIND_SELECT] TO rl_client_kind_r;
GO
