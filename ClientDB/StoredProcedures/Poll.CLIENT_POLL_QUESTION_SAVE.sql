...
GO
IF OBJECT_ID('[Poll].[CLIENT_POLL_QUESTION_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Poll].[CLIENT_POLL_QUESTION_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Poll].[CLIENT_POLL_QUESTION_SAVE]
