...
GO
IF OBJECT_ID('[Purchase].[CLIENT_CONDITION_CARD_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[CLIENT_CONDITION_CARD_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[CLIENT_CONDITION_CARD_SAVE]
	@ID					UNIQUEIDENTIFIER,
	@CLIENT				INT,
...
END
GO
GRANT EXECUTE ON [Purchase].[CLIENT_CONDITION_CARD_SAVE] TO rl_condition_card_u;
GO
