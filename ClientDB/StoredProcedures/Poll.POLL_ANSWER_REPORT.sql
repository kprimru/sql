...
GO
IF OBJECT_ID('[Poll].[POLL_ANSWER_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Poll].[POLL_ANSWER_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Poll].[POLL_ANSWER_REPORT]
	@ANS	NVARCHAR(MAX),
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME
AS
