...
GO
IF OBJECT_ID('[Cache].[NAME_CACHE_REFRESH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Cache].[NAME_CACHE_REFRESH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Cache].[NAME_CACHE_REFRESH]
