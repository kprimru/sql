...
GO
IF OBJECT_ID('[Report].[ONLINE_ACTIVITY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[ONLINE_ACTIVITY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[ONLINE_ACTIVITY]
