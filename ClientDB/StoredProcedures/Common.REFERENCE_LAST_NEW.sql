...
GO
IF OBJECT_ID('[Common].[REFERENCE_LAST_NEW]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Common].[REFERENCE_LAST_NEW]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Common].[REFERENCE_LAST_NEW]
