...
GO
IF OBJECT_ID('[dbo].[STUDY_CLAIM_CONTINUED]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_CLAIM_CONTINUED]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_CLAIM_CONTINUED]
	@ID			UNIQUEIDENTIFIER,
