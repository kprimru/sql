...
GO
IF OBJECT_ID('[dbo].[EXPERT_QUESTION_IMPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[EXPERT_QUESTION_IMPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[EXPERT_QUESTION_IMPORT]
	@DATA	NVARCHAR(MAX),
	@DUTY	INT
AS
BEGIN
