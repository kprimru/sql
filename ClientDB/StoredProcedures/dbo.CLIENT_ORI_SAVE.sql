...
GO
IF OBJECT_ID('[dbo].[CLIENT_ORI_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_ORI_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_ORI_SAVE]
	@CLIENT			INT,
	@NAME			VARCHAR(250),
	@VISIT			VARCHAR(100),
	@INFO			VARCHAR(MAX),
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_ORI_SAVE] TO rl_client_ori_u;
GO
