...
GO
IF OBJECT_ID('[dbo].[LESSON_PLACE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[LESSON_PLACE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[LESSON_PLACE_SELECT]
