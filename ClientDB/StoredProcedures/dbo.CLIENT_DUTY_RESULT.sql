...
GO
IF OBJECT_ID('[dbo].[CLIENT_DUTY_RESULT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DUTY_RESULT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DUTY_RESULT]
	@DUTY		INT,
	@ANS		TINYINT,
