...
GO
IF OBJECT_ID('[Report].[HOTLINE_SUBHOST_STAT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[HOTLINE_SUBHOST_STAT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[HOTLINE_SUBHOST_STAT]
