...
GO
IF OBJECT_ID('[dbo].[CLIENT_SEARCH_STAT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SEARCH_STAT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SEARCH_STAT]
	@CLIENT	INT
AS
BEGIN
	SET NOCOUNT ON;
