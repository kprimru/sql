...
GO
IF OBJECT_ID('[Subhost].[DOCUMENT_XML_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[DOCUMENT_XML_SELECT]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Subhost].[DOCUMENT_XML_SELECT]
	@SUBHOST	NVARCHAR(16),
	@START		SMALLDATETIME,
