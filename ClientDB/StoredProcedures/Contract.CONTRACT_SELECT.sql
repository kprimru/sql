...
GO
IF OBJECT_ID('[Contract].[CONTRACT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Contract].[CONTRACT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Contract].[CONTRACT_SELECT]
	@START			SMALLDATETIME,
