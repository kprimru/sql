...
GO
IF OBJECT_ID('[dbo].[HOTLINE_DISTR_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[HOTLINE_DISTR_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[HOTLINE_DISTR_PRINT]
	@NAME			NVARCHAR(128),
	@DISTR			INT,
	@SERVICE		INT
AS
...
GO
GRANT EXECUTE ON [dbo].[HOTLINE_DISTR_PRINT] TO rl_expert_distr;
GO
