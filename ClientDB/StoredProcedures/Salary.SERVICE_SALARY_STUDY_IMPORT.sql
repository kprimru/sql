...
GO
IF OBJECT_ID('[Salary].[SERVICE_SALARY_STUDY_IMPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[SERVICE_SALARY_STUDY_IMPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Salary].[SERVICE_SALARY_STUDY_IMPORT]
	@ID			UNIQUEIDENTIFIER,
