...
GO
IF OBJECT_ID('[dbo].[CONTROL_DOCUMENT_LOAD2]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CONTROL_DOCUMENT_LOAD2]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CONTROL_DOCUMENT_LOAD2]
	@Data	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
