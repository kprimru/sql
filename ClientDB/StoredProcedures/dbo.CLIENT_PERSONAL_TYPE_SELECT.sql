...
GO
IF OBJECT_ID('[dbo].[CLIENT_PERSONAL_TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_PERSONAL_TYPE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_PERSONAL_TYPE_SELECT]
