...
GO
IF OBJECT_ID('[dbo].[CONTROL_DOCUMENT_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CONTROL_DOCUMENT_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CONTROL_DOCUMENT_FILTER]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@MANAGER	INT = NULL
AS
