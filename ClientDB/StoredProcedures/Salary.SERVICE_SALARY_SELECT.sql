...
GO
IF OBJECT_ID('[Salary].[SERVICE_SALARY_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[SERVICE_SALARY_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Salary].[SERVICE_SALARY_SELECT]
