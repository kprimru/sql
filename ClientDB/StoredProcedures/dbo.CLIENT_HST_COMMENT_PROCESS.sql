...
GO
IF OBJECT_ID('[dbo].[CLIENT_HST_COMMENT_PROCESS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_HST_COMMENT_PROCESS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_HST_COMMENT_PROCESS]
	@CLIENT	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_HST_COMMENT_PROCESS] TO rl_hst_process;
GO
