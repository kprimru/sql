...
GO
IF OBJECT_ID('[dbo].[_SELECT_CONTRACT_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[_SELECT_CONTRACT_FILTER]  AS SELECT 1')
GO
...
END
GO
GRANT EXECUTE ON [dbo].[_SELECT_CONTRACT_FILTER] TO rl_filter_contract_type;
GO
