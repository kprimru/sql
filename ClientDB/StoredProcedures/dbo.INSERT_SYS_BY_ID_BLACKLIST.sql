...
GO
IF OBJECT_ID('[dbo].[INSERT_SYS_BY_ID_BLACKLIST]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[INSERT_SYS_BY_ID_BLACKLIST]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[INSERT_SYS_BY_ID_BLACKLIST]
	@ID_SYS INT,
	@DISTR INT,
	@COMP INT,
	@COMMENT VARCHAR(300),
