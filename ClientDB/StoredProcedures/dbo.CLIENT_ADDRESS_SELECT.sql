...
GO
IF OBJECT_ID('[dbo].[CLIENT_ADDRESS_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_ADDRESS_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_ADDRESS_SELECT]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
