...
GO
IF OBJECT_ID('[Purchase].[CONTRACT_EXECUTION_PROVISION_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[CONTRACT_EXECUTION_PROVISION_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[CONTRACT_EXECUTION_PROVISION_SELECT]
