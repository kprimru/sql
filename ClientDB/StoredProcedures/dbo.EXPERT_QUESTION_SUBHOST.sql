...
GO
IF OBJECT_ID('[dbo].[EXPERT_QUESTION_SUBHOST]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[EXPERT_QUESTION_SUBHOST]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[EXPERT_QUESTION_SUBHOST]
