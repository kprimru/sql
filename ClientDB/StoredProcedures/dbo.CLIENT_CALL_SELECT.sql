...
GO
IF OBJECT_ID('[dbo].[CLIENT_CALL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CALL_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CALL_SELECT]
	@CLIENT	INT
AS
BEGIN
	SET NOCOUNT ON;
