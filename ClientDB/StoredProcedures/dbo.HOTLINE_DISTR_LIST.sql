...
GO
IF OBJECT_ID('[dbo].[HOTLINE_DISTR_LIST]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[HOTLINE_DISTR_LIST]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[HOTLINE_DISTR_LIST]
AS
BEGIN
	SET NOCOUNT ON;
