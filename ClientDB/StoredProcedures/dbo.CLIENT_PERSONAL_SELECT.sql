...
GO
IF OBJECT_ID('[dbo].[CLIENT_PERSONAL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_PERSONAL_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_PERSONAL_SELECT]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
