...
GO
IF OBJECT_ID('[Poll].[BLANK_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Poll].[BLANK_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Poll].[BLANK_SAVE]
	@ID			UNIQUEIDENTIFIER,
	@NAME		NVARCHAR(128),
...
END
GO
GRANT EXECUTE ON [Poll].[BLANK_SAVE] TO rl_blank_u;
GO
