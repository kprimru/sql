...
GO
IF OBJECT_ID('[USR].[RES_VERSION_GRAPH_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[RES_VERSION_GRAPH_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[RES_VERSION_GRAPH_REPORT]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@MANAGER	INT,
	@SERVICE	INT
