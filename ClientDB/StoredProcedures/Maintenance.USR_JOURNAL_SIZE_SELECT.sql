...
GO
IF OBJECT_ID('[Maintenance].[USR_JOURNAL_SIZE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[USR_JOURNAL_SIZE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[USR_JOURNAL_SIZE_SELECT]
