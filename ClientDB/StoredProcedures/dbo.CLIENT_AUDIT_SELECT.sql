...
GO
IF OBJECT_ID('[dbo].[CLIENT_AUDIT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_AUDIT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_AUDIT_SELECT]
	@CLIENT	INT
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_AUDIT_SELECT] TO rl_client_audit_r;
GO
