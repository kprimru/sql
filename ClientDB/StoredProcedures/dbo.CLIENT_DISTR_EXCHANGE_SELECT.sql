...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_EXCHANGE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_EXCHANGE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_EXCHANGE_SELECT]
	@ID		UNIQUEIDENTIFIER,
	@SYSTEM	INT OUTPUT,
	@NET	INT OUTPUT,
