...
GO
IF OBJECT_ID('[Report].[ONLINE_ACTIVITY_PERCENT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[ONLINE_ACTIVITY_PERCENT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[ONLINE_ACTIVITY_PERCENT]
