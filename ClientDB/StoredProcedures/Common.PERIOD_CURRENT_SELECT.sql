...
GO
IF OBJECT_ID('[Common].[PERIOD_CURRENT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Common].[PERIOD_CURRENT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Common].[PERIOD_CURRENT_SELECT]
AS
BEGIN
	SET NOCOUNT ON;
