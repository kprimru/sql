...
GO
IF OBJECT_ID('[Maintenance].[USERLOG_TIME_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[USERLOG_TIME_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[USERLOG_TIME_REPORT]
	@START	SMALLDATETIME,
