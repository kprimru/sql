...
GO
IF OBJECT_ID('[Maintenance].[TABLE_STAT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[TABLE_STAT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[TABLE_STAT_SELECT]
