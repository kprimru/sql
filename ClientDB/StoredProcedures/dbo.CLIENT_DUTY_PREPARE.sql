...
GO
IF OBJECT_ID('[dbo].[CLIENT_DUTY_PREPARE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DUTY_PREPARE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DUTY_PREPARE]
	@CLIENT	INT,
