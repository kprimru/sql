...
GO
IF OBJECT_ID('[dbo].[STUDY_CLAIM_EXECUTE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_CLAIM_EXECUTE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_CLAIM_EXECUTE]
	@ID			UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[STUDY_CLAIM_EXECUTE] TO rl_client_study_i;
GO
