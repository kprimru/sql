...
GO
IF OBJECT_ID('[dbo].[CLIENT_STAT_PROCESS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_STAT_PROCESS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_STAT_PROCESS]
	@NAME	VARCHAR(256),
	@SIZE	BIGINT,
	@MD5	VARCHAR(64),
	@DATA	VARBINARY(MAX),
