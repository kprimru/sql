...
GO
IF OBJECT_ID('[dbo].[CLIENT_SEARCH_IMPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SEARCH_IMPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SEARCH_IMPORT]
	@CLIENTID INT,
