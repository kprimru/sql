...
GO
IF OBJECT_ID('[dbo].[SEMINAR_GRAPH_DOUBLE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SEMINAR_GRAPH_DOUBLE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SEMINAR_GRAPH_DOUBLE]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME
AS
BEGIN
