...
GO
IF OBJECT_ID('[Price].[COMMERCIAL_OFFER_MASTER_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Price].[COMMERCIAL_OFFER_MASTER_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Price].[COMMERCIAL_OFFER_MASTER_PRINT]
	@ID	UNIQUEIDENTIFIER
