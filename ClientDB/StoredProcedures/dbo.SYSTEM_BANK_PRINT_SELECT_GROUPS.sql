...
GO
IF OBJECT_ID('[dbo].[SYSTEM_BANK_PRINT_SELECT_GROUPS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_BANK_PRINT_SELECT_GROUPS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_BANK_PRINT_SELECT_GROUPS]
AS
BEGIN
	SET NOCOUNT ON;
