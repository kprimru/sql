...
GO
IF OBJECT_ID('[Common].[PERIOD_ACTIVE_YEAR]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Common].[PERIOD_ACTIVE_YEAR]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Common].[PERIOD_ACTIVE_YEAR]
	@ID			UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
