...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONNECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONNECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONNECT]
	@CLIENT	NVARCHAR(MAX),
	@DATE	SMALLDATETIME,
	@STATUS	INT,
	@SYSTEM	BIT,
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_CONNECT] TO rl_client_connect;
GO
