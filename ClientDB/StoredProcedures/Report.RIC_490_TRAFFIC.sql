...
GO
IF OBJECT_ID('[Report].[RIC_490_TRAFFIC]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[RIC_490_TRAFFIC]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[RIC_490_TRAFFIC]
