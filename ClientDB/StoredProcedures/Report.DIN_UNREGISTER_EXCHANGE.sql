...
GO
IF OBJECT_ID('[Report].[DIN_UNREGISTER_EXCHANGE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[DIN_UNREGISTER_EXCHANGE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[DIN_UNREGISTER_EXCHANGE]
