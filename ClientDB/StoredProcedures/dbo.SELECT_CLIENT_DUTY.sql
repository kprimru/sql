...
GO
IF OBJECT_ID('[dbo].[SELECT_CLIENT_DUTY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SELECT_CLIENT_DUTY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SELECT_CLIENT_DUTY]
	@clientid INT
AS
BEGIN
	SET NOCOUNT ON
