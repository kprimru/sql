...
GO
IF OBJECT_ID('[Training].[SEMINAR_SIGN_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Training].[SEMINAR_SIGN_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Training].[SEMINAR_SIGN_INSERT]
