...
GO
IF OBJECT_ID('[dbo].[CLIENT_TECH_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_TECH_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_TECH_SELECT]
	@CL_ID	INT
AS
BEGIN
	SET NOCOUNT ON;
