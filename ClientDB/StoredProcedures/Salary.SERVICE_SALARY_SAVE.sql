...
GO
IF OBJECT_ID('[Salary].[SERVICE_SALARY_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[SERVICE_SALARY_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Salary].[SERVICE_SALARY_SAVE]
