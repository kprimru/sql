...
GO
IF OBJECT_ID('[dbo].[CLIENT_DBF_DETAIL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DBF_DETAIL_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DBF_DETAIL_SELECT]
	@ID	INT
