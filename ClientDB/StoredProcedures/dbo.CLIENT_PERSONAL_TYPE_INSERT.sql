...
GO
IF OBJECT_ID('[dbo].[CLIENT_PERSONAL_TYPE_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_PERSONAL_TYPE_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_PERSONAL_TYPE_INSERT]
	@NAME		VARCHAR(100),
	@PSEDO		VARCHAR(50),
	@REQUIRED	BIT,
