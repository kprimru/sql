...
GO
IF OBJECT_ID('[dbo].[INFO_PANEL_USER_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[INFO_PANEL_USER_GET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[INFO_PANEL_USER_GET]
