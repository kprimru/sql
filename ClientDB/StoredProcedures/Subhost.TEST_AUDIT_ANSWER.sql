...
GO
IF OBJECT_ID('[Subhost].[TEST_AUDIT_ANSWER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[TEST_AUDIT_ANSWER]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Subhost].[TEST_AUDIT_ANSWER]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
