...
GO
IF OBJECT_ID('[dbo].[SYSTEM_BANKS_CREATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_BANKS_CREATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_BANKS_CREATE]
