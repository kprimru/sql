...
GO
IF OBJECT_ID('[Cache].[POSITION_CACHE_REFRESH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Cache].[POSITION_CACHE_REFRESH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Cache].[POSITION_CACHE_REFRESH]
