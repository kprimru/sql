...
GO
IF OBJECT_ID('[Memo].[KGS_CLIENT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Memo].[KGS_CLIENT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Memo].[KGS_CLIENT_SELECT]
	@LIST	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
