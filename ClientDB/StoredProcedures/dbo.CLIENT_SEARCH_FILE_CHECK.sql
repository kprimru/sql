...
GO
IF OBJECT_ID('[dbo].[CLIENT_SEARCH_FILE_CHECK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SEARCH_FILE_CHECK]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SEARCH_FILE_CHECK]
	@MD5	VARCHAR(100),
	@FILE	VARBINARY(MAX)
AS
BEGIN
