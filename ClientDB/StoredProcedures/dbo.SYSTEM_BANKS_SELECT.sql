...
GO
IF OBJECT_ID('[dbo].[SYSTEM_BANKS_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_BANKS_SELECT]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_BANKS_SELECT]
	@SYSID		INT,
	@DTYPEID	INT
AS
BEGIN
