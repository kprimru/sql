...
GO
IF OBJECT_ID('[Subhost].[ZVE_XML_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[ZVE_XML_SELECT]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Subhost].[ZVE_XML_SELECT]
	@SUBHOST	NVARCHAR(16),
	@START		SMALLDATETIME,
...
END
GO
GRANT EXECUTE ON [Subhost].[ZVE_XML_SELECT] TO rl_web_subhost;
GO
