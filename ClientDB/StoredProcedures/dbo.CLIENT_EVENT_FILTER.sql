...
GO
IF OBJECT_ID('[dbo].[CLIENT_EVENT_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_EVENT_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_EVENT_FILTER]
	@TYPE		NVARCHAR(MAX),
	@CLIENT		VARCHAR(500),
	@AUTHOR		NVARCHAR(128),
	@SERVICE	INT,
