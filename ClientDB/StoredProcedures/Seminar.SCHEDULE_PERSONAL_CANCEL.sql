...
GO
IF OBJECT_ID('[Seminar].[SCHEDULE_PERSONAL_CANCEL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Seminar].[SCHEDULE_PERSONAL_CANCEL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Seminar].[SCHEDULE_PERSONAL_CANCEL]
	@ID			UNIQUEIDENTIFIER,
