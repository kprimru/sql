...
GO
IF OBJECT_ID('[dbo].[SYSTEM_BANKS_DELETE(OLD)]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_BANKS_DELETE(OLD)]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_BANKS_DELETE(OLD)]
...
GO
GRANT EXECUTE ON [dbo].[SYSTEM_BANKS_DELETE(OLD)] TO rl_system_bank_d;
GO
