...
GO
IF OBJECT_ID('[Report].[DISCONNECT_EMAIL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[DISCONNECT_EMAIL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[DISCONNECT_EMAIL]
