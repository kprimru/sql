...
GO
IF OBJECT_ID('[Control].[CLIENT_CONTROL_WARNING]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Control].[CLIENT_CONTROL_WARNING]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Control].[CLIENT_CONTROL_WARNING]
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [Control].[CLIENT_CONTROL_WARNING] TO rl_control_audit;
