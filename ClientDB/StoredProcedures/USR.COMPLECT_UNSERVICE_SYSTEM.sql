...
GO
IF OBJECT_ID('[USR].[COMPLECT_UNSERVICE_SYSTEM]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[COMPLECT_UNSERVICE_SYSTEM]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[COMPLECT_UNSERVICE_SYSTEM]
	@MANAGER	INT,
	@SERVICE	INT,
