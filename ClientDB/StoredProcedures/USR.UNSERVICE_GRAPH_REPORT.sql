...
GO
IF OBJECT_ID('[USR].[UNSERVICE_GRAPH_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[UNSERVICE_GRAPH_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[UNSERVICE_GRAPH_REPORT]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@MANAGER	INT,
	@SERVICE	INT
