...
GO
IF OBJECT_ID('[Seminar].[SCHEDULE_PERSONAL_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Seminar].[SCHEDULE_PERSONAL_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Seminar].[SCHEDULE_PERSONAL_SAVE]
