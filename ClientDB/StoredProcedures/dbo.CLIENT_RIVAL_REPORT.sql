...
GO
IF OBJECT_ID('[dbo].[CLIENT_RIVAL_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_RIVAL_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_RIVAL_REPORT]
	@CL_ID INT,
