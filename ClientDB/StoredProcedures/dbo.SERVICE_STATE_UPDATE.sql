...
GO
IF OBJECT_ID('[dbo].[SERVICE_STATE_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_STATE_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_STATE_UPDATE]
	@SERVICE	INT
AS
BEGIN
	SET NOCOUNT ON;
