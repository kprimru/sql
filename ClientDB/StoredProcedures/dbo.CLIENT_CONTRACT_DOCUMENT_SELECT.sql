...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONTRACT_DOCUMENT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONTRACT_DOCUMENT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONTRACT_DOCUMENT_SELECT]
	@ID INT
AS
BEGIN
	SET NOCOUNT ON;
