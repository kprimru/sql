...
GO
IF OBJECT_ID('[dbo].[GET_BLACKLIST_PARAM]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[GET_BLACKLIST_PARAM]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [dbo].[GET_BLACKLIST_PARAM]
