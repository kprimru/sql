...
GO
IF OBJECT_ID('[dbo].[CLIENT_MESSAGE_READ]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_MESSAGE_READ]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_MESSAGE_READ]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_MESSAGE_READ] TO rl_client_message_r;
GO
