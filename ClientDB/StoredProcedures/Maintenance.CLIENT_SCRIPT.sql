...
GO
IF OBJECT_ID('[Maintenance].[CLIENT_SCRIPT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[CLIENT_SCRIPT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[CLIENT_SCRIPT]
	@ID		INT,
