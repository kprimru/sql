...
GO
IF OBJECT_ID('[Mailing].[WEB_DISTR_CHECK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Mailing].[WEB_DISTR_CHECK]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Mailing].[WEB_DISTR_CHECK]
	@STR	NVARCHAR(64),
