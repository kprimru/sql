...
GO
IF OBJECT_ID('[Report].[HOTLINE_DAY_STAT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[HOTLINE_DAY_STAT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[HOTLINE_DAY_STAT]
	@PARAM	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
