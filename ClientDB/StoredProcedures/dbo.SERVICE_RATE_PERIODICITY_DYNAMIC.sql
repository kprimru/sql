...
GO
IF OBJECT_ID('[dbo].[SERVICE_RATE_PERIODICITY_DYNAMIC]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_RATE_PERIODICITY_DYNAMIC]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_RATE_PERIODICITY_DYNAMIC]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SERVICE	INT,
	@TYPE		VARCHAR(MAX)
