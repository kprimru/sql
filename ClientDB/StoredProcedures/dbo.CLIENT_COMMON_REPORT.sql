...
GO
IF OBJECT_ID('[dbo].[CLIENT_COMMON_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_COMMON_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_COMMON_REPORT]
	@DATE		SMALLDATETIME,
	@DS_PERIOD	TINYINT,
	@SERVICE	INT = NULL,
	@MANAGER	INT = NULL,
