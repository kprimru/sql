...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISCOUNT_WARNING]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISCOUNT_WARNING]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISCOUNT_WARNING]
AS
BEGIN
	SET NOCOUNT ON;
