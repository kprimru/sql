...
GO
IF OBJECT_ID('[dbo].[CLIENT_TRUST_WARNING]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_TRUST_WARNING]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_TRUST_WARNING]
AS
BEGIN
	SET NOCOUNT ON;
