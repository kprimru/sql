...
GO
IF OBJECT_ID('[dbo].[CLIENT_EVENT_PERSONAL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_EVENT_PERSONAL_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_EVENT_PERSONAL_SELECT]
AS
BEGIN
	SET NOCOUNT ON;
