...
GO
IF OBJECT_ID('[dbo].[GET_INFOBANKS_FOR_COMPLECT_DEMO]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[GET_INFOBANKS_FOR_COMPLECT_DEMO]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[GET_INFOBANKS_FOR_COMPLECT_DEMO]
	@SYSID INT
AS
BEGIN
	SET NOCOUNT ON
