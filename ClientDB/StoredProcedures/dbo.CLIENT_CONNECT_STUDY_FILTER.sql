...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONNECT_STUDY_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONNECT_STUDY_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONNECT_STUDY_FILTER]
