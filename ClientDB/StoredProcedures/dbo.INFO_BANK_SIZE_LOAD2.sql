...
GO
IF OBJECT_ID('[dbo].[INFO_BANK_SIZE_LOAD2]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[INFO_BANK_SIZE_LOAD2]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[INFO_BANK_SIZE_LOAD2]
	@Data	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
