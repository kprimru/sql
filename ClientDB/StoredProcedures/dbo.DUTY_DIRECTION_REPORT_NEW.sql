...
GO
IF OBJECT_ID('[dbo].[DUTY_DIRECTION_REPORT_NEW]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[DUTY_DIRECTION_REPORT_NEW]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[DUTY_DIRECTION_REPORT_NEW]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SERVICE	INT,
	@DUTY		INT = NULL
