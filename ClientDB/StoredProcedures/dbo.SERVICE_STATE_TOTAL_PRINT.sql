...
GO
IF OBJECT_ID('[dbo].[SERVICE_STATE_TOTAL_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_STATE_TOTAL_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_STATE_TOTAL_PRINT]
