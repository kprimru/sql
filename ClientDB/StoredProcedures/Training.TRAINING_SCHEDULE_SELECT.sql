...
GO
IF OBJECT_ID('[Training].[TRAINING_SCHEDULE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Training].[TRAINING_SCHEDULE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Training].[TRAINING_SCHEDULE_SELECT]
