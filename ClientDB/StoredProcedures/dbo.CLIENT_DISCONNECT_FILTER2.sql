...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISCONNECT_FILTER2]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISCONNECT_FILTER2]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISCONNECT_FILTER2]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
