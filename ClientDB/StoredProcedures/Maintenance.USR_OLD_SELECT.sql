...
GO
IF OBJECT_ID('[Maintenance].[USR_OLD_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[USR_OLD_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[USR_OLD_SELECT]
	@LAST_COUNT	SMALLINT,
