...
GO
IF OBJECT_ID('[dbo].[CLIENT_INNOVATION_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_INNOVATION_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_INNOVATION_FILTER]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
