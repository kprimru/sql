...
GO
IF OBJECT_ID('[dbo].[CLIENT_QUESTION_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_QUESTION_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_QUESTION_UPDATE]
	@id INT,
	@questionid INT,
	@answerid INT,
	@text VARCHAR(150),
