...
GO
IF OBJECT_ID('[dbo].[SERVICE_RATE_DETAIL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_RATE_DETAIL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_RATE_DETAIL]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SERVICE	INT,
	@TYPE		VARCHAR(MAX),
