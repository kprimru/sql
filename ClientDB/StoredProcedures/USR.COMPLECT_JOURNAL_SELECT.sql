...
GO
IF OBJECT_ID('[USR].[COMPLECT_JOURNAL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[COMPLECT_JOURNAL_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[COMPLECT_JOURNAL_SELECT]
	@UD_COMPLECT	INT
AS
BEGIN
	SET NOCOUNT ON;
