...
GO
IF OBJECT_ID('[dbo].[CLIENT_SYSTEM_CHECK_HOST]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SYSTEM_CHECK_HOST]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SYSTEM_CHECK_HOST]
	@ID		INT,
	@SYS	INT,
	@DISTR	INT,
	@COMP	TINYINT
