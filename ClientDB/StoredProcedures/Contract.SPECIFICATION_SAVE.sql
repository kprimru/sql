...
GO
IF OBJECT_ID('[Contract].[SPECIFICATION_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Contract].[SPECIFICATION_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Contract].[SPECIFICATION_SAVE]
