...
GO
IF OBJECT_ID('[dbo].[SERVICE_STATE_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_STATE_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_STATE_PRINT]
	@SERVICE	INT,
	@TP			NVARCHAR(MAX)
AS
BEGIN
...
END
GO
GRANT EXECUTE ON [dbo].[SERVICE_STATE_PRINT] TO rl_service_state_r;
GO
