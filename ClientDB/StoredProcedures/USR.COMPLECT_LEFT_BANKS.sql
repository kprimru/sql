...
GO
IF OBJECT_ID('[USR].[COMPLECT_LEFT_BANKS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[COMPLECT_LEFT_BANKS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[COMPLECT_LEFT_BANKS]
	@MANAGER	INT = NULL,
	@SERVICE	INT = NULL,
