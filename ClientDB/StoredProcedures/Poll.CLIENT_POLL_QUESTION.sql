...
GO
IF OBJECT_ID('[Poll].[CLIENT_POLL_QUESTION]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Poll].[CLIENT_POLL_QUESTION]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Poll].[CLIENT_POLL_QUESTION]
	@ID		UNIQUEIDENTIFIER,
