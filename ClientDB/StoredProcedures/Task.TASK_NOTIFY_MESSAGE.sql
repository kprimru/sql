...
GO
IF OBJECT_ID('[Task].[TASK_NOTIFY_MESSAGE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Task].[TASK_NOTIFY_MESSAGE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Task].[TASK_NOTIFY_MESSAGE]
AS
BEGIN
	SET NOCOUNT ON;
