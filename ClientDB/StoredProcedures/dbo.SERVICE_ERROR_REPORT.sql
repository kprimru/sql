...
GO
IF OBJECT_ID('[dbo].[SERVICE_ERROR_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_ERROR_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_ERROR_REPORT]
	@SERVICE	INT,
	@DATE		SMALLDATETIME,
