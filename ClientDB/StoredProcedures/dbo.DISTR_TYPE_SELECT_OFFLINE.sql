...
GO
IF OBJECT_ID('[dbo].[DISTR_TYPE_SELECT_OFFLINE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[DISTR_TYPE_SELECT_OFFLINE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[DISTR_TYPE_SELECT_OFFLINE]
