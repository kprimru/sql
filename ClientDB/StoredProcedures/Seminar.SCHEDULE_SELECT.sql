...
GO
IF OBJECT_ID('[Seminar].[SCHEDULE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Seminar].[SCHEDULE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Seminar].[SCHEDULE_SELECT]
