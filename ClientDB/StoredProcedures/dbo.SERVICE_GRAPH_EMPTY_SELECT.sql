...
GO
IF OBJECT_ID('[dbo].[SERVICE_GRAPH_EMPTY_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_GRAPH_EMPTY_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_GRAPH_EMPTY_SELECT]
	@SERVICE	INT
AS
BEGIN
	SET NOCOUNT ON;
