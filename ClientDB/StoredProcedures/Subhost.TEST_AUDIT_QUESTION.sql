...
GO
IF OBJECT_ID('[Subhost].[TEST_AUDIT_QUESTION]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[TEST_AUDIT_QUESTION]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Subhost].[TEST_AUDIT_QUESTION]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
