...
GO
IF OBJECT_ID('[Report].[ONLINE_INACTIVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[ONLINE_INACTIVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[ONLINE_INACTIVE]
