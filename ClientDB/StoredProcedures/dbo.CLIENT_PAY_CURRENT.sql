...
GO
IF OBJECT_ID('[dbo].[CLIENT_PAY_CURRENT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_PAY_CURRENT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_PAY_CURRENT]
	@CLIENT	INT,
