...
GO
IF OBJECT_ID('[USR].[SERVICE_TIME_GRAPH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[SERVICE_TIME_GRAPH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[SERVICE_TIME_GRAPH]
	@SERVICE	INT,
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@TYPE		VARCHAR(MAX),
