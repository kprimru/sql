...
GO
IF OBJECT_ID('[dbo].[CLIENT_QUESTION_ANSWER_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_QUESTION_ANSWER_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_QUESTION_ANSWER_FILTER]
	@questionid INT,
	@serviceid INT,
