...
GO
IF OBJECT_ID('[dbo].[CLIENT_PAY_DYNAMIC]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_PAY_DYNAMIC]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_PAY_DYNAMIC]
	@CLIENT	INT
AS
BEGIN
	SET NOCOUNT ON;
