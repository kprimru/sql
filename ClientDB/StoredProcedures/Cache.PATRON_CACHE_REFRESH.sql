...
GO
IF OBJECT_ID('[Cache].[PATRON_CACHE_REFRESH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Cache].[PATRON_CACHE_REFRESH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Cache].[PATRON_CACHE_REFRESH]
