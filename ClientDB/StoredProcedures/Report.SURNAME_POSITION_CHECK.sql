...
GO
IF OBJECT_ID('[Report].[SURNAME_POSITION_CHECK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[SURNAME_POSITION_CHECK]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[SURNAME_POSITION_CHECK]
