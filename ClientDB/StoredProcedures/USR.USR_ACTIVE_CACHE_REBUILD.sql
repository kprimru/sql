...
GO
IF OBJECT_ID('[USR].[USR_ACTIVE_CACHE_REBUILD]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[USR_ACTIVE_CACHE_REBUILD]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[USR_ACTIVE_CACHE_REBUILD]
    @UD_ID      Int
AS
BEGIN
	SET NOCOUNT ON;
