...
GO
IF OBJECT_ID('[Report].[CHAT_INFILTRATION]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[CHAT_INFILTRATION]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[CHAT_INFILTRATION]
...
END
GO
GRANT EXECUTE ON [Report].[CHAT_INFILTRATION] TO rl_report;
GO
