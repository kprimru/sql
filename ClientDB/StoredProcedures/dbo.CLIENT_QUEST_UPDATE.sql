...
GO
IF OBJECT_ID('[dbo].[CLIENT_QUEST_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_QUEST_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_QUEST_UPDATE]
	@ID	INT,
	@CLIENT	INT,
	@DATE	SMALLDATETIME,
	@QUEST	INT,
