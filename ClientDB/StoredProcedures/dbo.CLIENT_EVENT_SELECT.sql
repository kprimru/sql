...
GO
IF OBJECT_ID('[dbo].[CLIENT_EVENT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_EVENT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_EVENT_SELECT]
	@CLIENT	INT,
