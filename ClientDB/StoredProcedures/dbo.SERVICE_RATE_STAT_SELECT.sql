...
GO
IF OBJECT_ID('[dbo].[SERVICE_RATE_STAT_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_RATE_STAT_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_RATE_STAT_SELECT]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SERVICE	INT,
	@MANAGER	VARCHAR(MAX),
...
BEGIN
	...
	BEGIN TRY
		...
		DECLARE @MON_COUNT	SMALLINT

		SELECT @MON_COUNT = COUNT(*)
		FROM @MONTH
