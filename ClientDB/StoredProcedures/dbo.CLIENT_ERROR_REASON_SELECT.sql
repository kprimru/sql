...
GO
IF OBJECT_ID('[dbo].[CLIENT_ERROR_REASON_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_ERROR_REASON_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_ERROR_REASON_SELECT]
	@TP			NVARCHAR(128)
AS
BEGIN
	SET NOCOUNT ON;
