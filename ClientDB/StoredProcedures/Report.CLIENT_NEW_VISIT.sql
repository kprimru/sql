...
GO
IF OBJECT_ID('[Report].[CLIENT_NEW_VISIT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[CLIENT_NEW_VISIT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[CLIENT_NEW_VISIT]
