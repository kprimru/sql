...
GO
IF OBJECT_ID('[dbo].[SERVICE_RATE_STAT_DYNAMIC]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_RATE_STAT_DYNAMIC]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_RATE_STAT_DYNAMIC]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SERVICE	INT,
	@TYPE		VARCHAR(MAX)
...
END
GO
GRANT EXECUTE ON [dbo].[SERVICE_RATE_STAT_DYNAMIC] TO rl_service_rate;
GO
