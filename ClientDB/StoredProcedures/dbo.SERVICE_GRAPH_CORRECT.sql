...
GO
IF OBJECT_ID('[dbo].[SERVICE_GRAPH_CORRECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_GRAPH_CORRECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_GRAPH_CORRECT]
	@serviceid INT,
	@alph BIT = NULL
AS
BEGIN
