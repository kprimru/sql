...
GO
IF OBJECT_ID('[dbo].[HOTLINE_CHAT_IMPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[HOTLINE_CHAT_IMPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[HOTLINE_CHAT_IMPORT]
	@DATA	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
