...
GO
IF OBJECT_ID('[dbo].[CLIENT_DELIVERY_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DELIVERY_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DELIVERY_SELECT]
	@CLIENT	INT
AS
BEGIN
	SET NOCOUNT ON;
