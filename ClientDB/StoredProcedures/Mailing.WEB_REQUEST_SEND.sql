...
GO
IF OBJECT_ID('[Mailing].[WEB_REQUEST_SEND]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Mailing].[WEB_REQUEST_SEND]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Mailing].[WEB_REQUEST_SEND]
	@DistrS		VarChar(100),
	@Email		VarChar(100),
