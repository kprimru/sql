...
GO
IF OBJECT_ID('[dbo].[SYSTEM_ORDER_SET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_ORDER_SET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_ORDER_SET]
	@DATA	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[SYSTEM_ORDER_SET] TO rl_system_order;
GO
