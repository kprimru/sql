...
GO
IF OBJECT_ID('[dbo].[EXPERT_DISTR_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[EXPERT_DISTR_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[EXPERT_DISTR_SELECT]
	@NAME			NVARCHAR(128),
	@DISTR			INT,
	@SERVICE		INT,
	@MANAGER		INT,
...
END
GO
GRANT EXECUTE ON [dbo].[EXPERT_DISTR_SELECT] TO rl_expert_distr;
GO
