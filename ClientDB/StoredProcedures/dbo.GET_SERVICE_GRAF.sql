...
GO
IF OBJECT_ID('[dbo].[GET_SERVICE_GRAF]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[GET_SERVICE_GRAF]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[GET_SERVICE_GRAF]
	@serviceid INT,
	@alph BIT = NULL
AS
BEGIN
...
END
GO
GRANT EXECUTE ON [dbo].[GET_SERVICE_GRAF] TO rl_report_service_graf;
GO
