...
GO
IF OBJECT_ID('[Security].[CLIENT_LIST_SET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Security].[CLIENT_LIST_SET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Security].[CLIENT_LIST_SET]
	@ID		INT,
	@RALL	BIT,
	@RMAN	BIT,
	@RSER	BIT,
