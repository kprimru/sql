...
GO
IF OBJECT_ID('[dbo].[STUDY_TEACHER_REPORT_NEW]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_TEACHER_REPORT_NEW]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_TEACHER_REPORT_NEW]
