...
GO
IF OBJECT_ID('[dbo].[STUDY_VISIT_DELETE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_VISIT_DELETE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_VISIT_DELETE]
	@ID			UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
