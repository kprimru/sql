...
GO
IF OBJECT_ID('[Purchase].[CLIENT_CONDITION_PLACEMENT_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[CLIENT_CONDITION_PLACEMENT_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[CLIENT_CONDITION_PLACEMENT_SAVE]
	@CLIENT				INT,
