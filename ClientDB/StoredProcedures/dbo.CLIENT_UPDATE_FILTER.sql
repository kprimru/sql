...
GO
IF OBJECT_ID('[dbo].[CLIENT_UPDATE_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_UPDATE_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_UPDATE_FILTER]
	@MANAGER	INT,
	@SERVICE	INT,
	@STYPE		VARCHAR(MAX),
	@BEGIN		SMALLDATETIME,
