...
GO
IF OBJECT_ID('[dbo].[CLIENT_MESSAGE_SEND]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_MESSAGE_SEND]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_MESSAGE_SEND]
	@CLIENT			INT,
	@TYPE			TINYINT,
