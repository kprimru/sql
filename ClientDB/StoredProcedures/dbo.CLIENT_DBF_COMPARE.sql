...
GO
IF OBJECT_ID('[dbo].[CLIENT_DBF_COMPARE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DBF_COMPARE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DBF_COMPARE]
	@MANAGER	INT,
	@SERVICE	INT,
	@TYPE		NVARCHAR(MAX)
