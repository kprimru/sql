...
GO
IF OBJECT_ID('[dbo].[SATISFACTION_QUESTION_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SATISFACTION_QUESTION_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SATISFACTION_QUESTION_REPORT]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME
AS
BEGIN
