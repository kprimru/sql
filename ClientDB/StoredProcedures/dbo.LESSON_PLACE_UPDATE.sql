...
GO
IF OBJECT_ID('[dbo].[LESSON_PLACE_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[LESSON_PLACE_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[LESSON_PLACE_UPDATE]
	@ID	INT,
	@NAME	VARCHAR(100),
	@REPORT	BIT
AS
