...
GO
IF OBJECT_ID('[USR].[UPDATE_PERIOD_AUDIT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[UPDATE_PERIOD_AUDIT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[UPDATE_PERIOD_AUDIT]
	@MANAGER	INT,
	@SERVICE	INT,
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
