...
GO
IF OBJECT_ID('[Salary].[SERVICE_SALARY_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[SERVICE_SALARY_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Salary].[SERVICE_SALARY_PRINT]
