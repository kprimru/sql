...
GO
IF OBJECT_ID('[dbo].[SYSTEM_SELECT_ORDER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_SELECT_ORDER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_SELECT_ORDER]
AS
BEGIN
	SET NOCOUNT ON;
