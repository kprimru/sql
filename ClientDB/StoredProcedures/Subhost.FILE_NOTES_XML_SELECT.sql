...
GO
IF OBJECT_ID('[Subhost].[FILE_NOTES_XML_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[FILE_NOTES_XML_SELECT]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Subhost].[FILE_NOTES_XML_SELECT]
	@SH		NVARCHAR(16),
