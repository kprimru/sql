...
GO
IF OBJECT_ID('[dbo].[DUTY_SYSTEM_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[DUTY_SYSTEM_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[DUTY_SYSTEM_REPORT]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SERVICE	INT,
	@MANAGER	INT,
