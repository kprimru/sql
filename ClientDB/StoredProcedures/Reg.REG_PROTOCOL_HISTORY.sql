...
GO
IF OBJECT_ID('[Reg].[REG_PROTOCOL_HISTORY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Reg].[REG_PROTOCOL_HISTORY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Reg].[REG_PROTOCOL_HISTORY]
	@Host			SmallInt,
	@Distr			Int,
	@Comp			TinyInt
AS
