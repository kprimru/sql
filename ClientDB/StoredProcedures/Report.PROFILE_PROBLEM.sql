...
GO
IF OBJECT_ID('[Report].[PROFILE_PROBLEM]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[PROFILE_PROBLEM]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[PROFILE_PROBLEM]
