...
GO
IF OBJECT_ID('[Tender].[CALC_DETAIL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Tender].[CALC_DETAIL_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Tender].[CALC_DETAIL_SELECT]
	@DATA	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
