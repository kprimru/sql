...
GO
IF OBJECT_ID('[dbo].[CLIENT_MESSAGE_NOTIFY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_MESSAGE_NOTIFY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_MESSAGE_NOTIFY]
AS
BEGIN
	SET NOCOUNT ON;
