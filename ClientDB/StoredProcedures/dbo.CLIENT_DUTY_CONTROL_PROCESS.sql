...
GO
IF OBJECT_ID('[dbo].[CLIENT_DUTY_CONTROL_PROCESS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DUTY_CONTROL_PROCESS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DUTY_CONTROL_PROCESS]
