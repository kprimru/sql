...
GO
IF OBJECT_ID('[dbo].[CLIENT_QUEST_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_QUEST_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_QUEST_INSERT]
	@CLIENT	INT,
	@DATE	SMALLDATETIME,
	@QUEST	INT,
	@ANS	INT,
