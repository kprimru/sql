...
GO
IF OBJECT_ID('[USR].[CLIENT_DETAIL_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[CLIENT_DETAIL_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[CLIENT_DETAIL_REPORT]
	@CL_ID		INT,
