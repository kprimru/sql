...
GO
IF OBJECT_ID('[dbo].[CLIENT_SYSTEM_HISTORY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SYSTEM_HISTORY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SYSTEM_HISTORY]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
