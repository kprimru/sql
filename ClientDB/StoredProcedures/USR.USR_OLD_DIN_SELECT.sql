...
GO
IF OBJECT_ID('[USR].[USR_OLD_DIN_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[USR_OLD_DIN_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[USR_OLD_DIN_SELECT]
	@MANAGER	INT,
	@SERVICE	INT
AS
BEGIN
