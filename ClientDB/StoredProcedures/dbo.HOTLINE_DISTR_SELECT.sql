...
GO
IF OBJECT_ID('[dbo].[HOTLINE_DISTR_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[HOTLINE_DISTR_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[HOTLINE_DISTR_SELECT]
	@NAME			NVARCHAR(128),
	@DISTR			INT,
	@SERVICE		INT,
	@MANAGER		INT,
