...
GO
IF OBJECT_ID('[Maintenance].[DATABASE_CLEAR (AUTO)]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[DATABASE_CLEAR (AUTO)]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[DATABASE_CLEAR (AUTO)]
AS
BEGIN
	SET NOCOUNT ON;
