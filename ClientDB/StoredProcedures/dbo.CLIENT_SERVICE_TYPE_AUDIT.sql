...
GO
IF OBJECT_ID('[dbo].[CLIENT_SERVICE_TYPE_AUDIT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SERVICE_TYPE_AUDIT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SERVICE_TYPE_AUDIT]
	@MANAGER	INT,
	@SERVICE	INT
AS
BEGIN
