...
GO
IF OBJECT_ID('[Common].[MAILING_ERRORS_NOTIFY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Common].[MAILING_ERRORS_NOTIFY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Common].[MAILING_ERRORS_NOTIFY]
AS
BEGIN
	SET NOCOUNT ON;
