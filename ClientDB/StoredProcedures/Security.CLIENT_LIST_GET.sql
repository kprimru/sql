...
GO
IF OBJECT_ID('[Security].[CLIENT_LIST_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Security].[CLIENT_LIST_GET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Security].[CLIENT_LIST_GET]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
