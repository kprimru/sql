...
GO
IF OBJECT_ID('[Control].[CONTROL_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Control].[CONTROL_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Control].[CONTROL_FILTER]
	@START		SMALLDATETIME,
