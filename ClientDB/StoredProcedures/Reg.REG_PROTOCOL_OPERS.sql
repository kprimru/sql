...
GO
IF OBJECT_ID('[Reg].[REG_PROTOCOL_OPERS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Reg].[REG_PROTOCOL_OPERS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Reg].[REG_PROTOCOL_OPERS]
AS
BEGIN
	SET NOCOUNT ON;
