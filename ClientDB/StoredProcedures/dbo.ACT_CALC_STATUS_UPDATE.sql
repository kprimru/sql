...
GO
IF OBJECT_ID('[dbo].[ACT_CALC_STATUS_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[ACT_CALC_STATUS_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[ACT_CALC_STATUS_UPDATE]
AS
BEGIN
	SET NOCOUNT ON;
