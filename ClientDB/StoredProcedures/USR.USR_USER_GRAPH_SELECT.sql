...
GO
IF OBJECT_ID('[USR].[USR_USER_GRAPH_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[USR_USER_GRAPH_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[USR_USER_GRAPH_SELECT]
	@COMPLECT	INT,
	@START		SMALLDATETIME,
