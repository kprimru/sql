...
GO
IF OBJECT_ID('[USR].[SERVICE_COMMON_GRAPH (NEW)]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[SERVICE_COMMON_GRAPH (NEW)]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[SERVICE_COMMON_GRAPH (NEW)]
	@Service	Int,
	@Start		SmallDateTime,
