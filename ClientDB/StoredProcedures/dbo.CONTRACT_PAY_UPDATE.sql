...
GO
IF OBJECT_ID('[dbo].[CONTRACT_PAY_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CONTRACT_PAY_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CONTRACT_PAY_UPDATE]
	@ID	INT,
	@NAME	VARCHAR(100),
	@DAY	SMALLINT,
	@MONTH	SMALLINT
