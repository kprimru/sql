...
GO
IF OBJECT_ID('[dbo].[SATISFACTION_QUESTION_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SATISFACTION_QUESTION_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SATISFACTION_QUESTION_INSERT]
	@TEXT	VARCHAR(500),
	@SINGLE	BIT,
	@BOLD	BIT,
	@ORDER	INT,
