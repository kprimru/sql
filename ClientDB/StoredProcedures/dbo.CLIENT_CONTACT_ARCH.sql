...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONTACT_ARCH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONTACT_ARCH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONTACT_ARCH]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
