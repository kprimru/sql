...
GO
IF OBJECT_ID('[dbo].[STUDY_CLAIM_MEETING]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_CLAIM_MEETING]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_CLAIM_MEETING]
	@ID			UNIQUEIDENTIFIER,
	@DATE		DATETIME,
	@NOTE		NVARCHAR(MAX)
AS
...
END
GO
GRANT EXECUTE ON [dbo].[STUDY_CLAIM_MEETING] TO rl_client_study_i;
GO
