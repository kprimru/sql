...
GO
IF OBJECT_ID('[dbo].[IMPORT_ONLINE_DATA]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[IMPORT_ONLINE_DATA]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[IMPORT_ONLINE_DATA]
	@DATA		NVARCHAR(MAX),
