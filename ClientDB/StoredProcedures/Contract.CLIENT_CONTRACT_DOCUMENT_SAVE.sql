...
GO
IF OBJECT_ID('[Contract].[CLIENT_CONTRACT_DOCUMENT_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Contract].[CLIENT_CONTRACT_DOCUMENT_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Contract].[CLIENT_CONTRACT_DOCUMENT_SAVE]
