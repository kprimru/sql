...
GO
IF OBJECT_ID('[Mailing].[ADDRESS_LIST_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Mailing].[ADDRESS_LIST_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Mailing].[ADDRESS_LIST_SELECT]
