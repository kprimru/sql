...
GO
IF OBJECT_ID('[dbo].[CLIENT_RIVAL_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_RIVAL_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_RIVAL_FILTER]
	@BEGIN			SMALLDATETIME,
	@END			SMALLDATETIME,
	@CONTROL		BIT,
