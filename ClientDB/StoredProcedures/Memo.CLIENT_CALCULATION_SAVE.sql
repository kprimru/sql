...
GO
IF OBJECT_ID('[Memo].[CLIENT_CALCULATION_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Memo].[CLIENT_CALCULATION_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Memo].[CLIENT_CALCULATION_SAVE]
	@ID			UNIQUEIDENTIFIER,
	@CLIENT		INT,
	@NOTE		NVARCHAR(MAX),
	@DATE		SMALLDATETIME,
