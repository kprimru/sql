...
GO
IF OBJECT_ID('[Din].[NetType@Select?Synonyms]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Din].[NetType@Select?Synonyms]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Din].[NetType@Select?Synonyms]
AS
BEGIN
	SET NOCOUNT ON;
