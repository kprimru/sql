...
GO
IF OBJECT_ID('[dbo].[CLIENT_WORK_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_WORK_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_WORK_SELECT]
	@CLIENT	INT,
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@TYPE	NVARCHAR(MAX)
