...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_REG_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_REG_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_REG_SELECT]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
