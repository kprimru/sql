...
GO
IF OBJECT_ID('[dbo].[CLIENT_FULL_SEARCH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_FULL_SEARCH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_FULL_SEARCH]
