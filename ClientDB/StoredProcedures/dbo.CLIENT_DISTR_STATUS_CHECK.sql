...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_STATUS_CHECK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_STATUS_CHECK]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_STATUS_CHECK]
AS
BEGIN
	SET NOCOUNT ON;
