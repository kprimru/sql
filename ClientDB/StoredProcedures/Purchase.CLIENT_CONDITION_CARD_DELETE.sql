...
GO
IF OBJECT_ID('[Purchase].[CLIENT_CONDITION_CARD_DELETE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[CLIENT_CONDITION_CARD_DELETE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[CLIENT_CONDITION_CARD_DELETE]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
