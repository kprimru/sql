...
GO
IF OBJECT_ID('[dbo].[ONLINE_ACTIVITY_LOAD]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[ONLINE_ACTIVITY_LOAD]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[ONLINE_ACTIVITY_LOAD]
	@YEAR		INT,
	@WEEK_NUM	INT,
	@LOGIN		NVARCHAR(256),
	@ACTIVITY	BIT = NULL,
