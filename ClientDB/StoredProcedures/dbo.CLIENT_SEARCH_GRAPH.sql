...
GO
IF OBJECT_ID('[dbo].[CLIENT_SEARCH_GRAPH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SEARCH_GRAPH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SEARCH_GRAPH]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME
AS
BEGIN
