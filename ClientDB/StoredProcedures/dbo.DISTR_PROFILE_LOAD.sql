...
GO
IF OBJECT_ID('[dbo].[DISTR_PROFILE_LOAD]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[DISTR_PROFILE_LOAD]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[DISTR_PROFILE_LOAD]
