...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_RESTORE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_RESTORE]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_RESTORE]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_DISTR_RESTORE] TO rl_client_distr_d;
GO
