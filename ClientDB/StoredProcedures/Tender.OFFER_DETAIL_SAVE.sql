...
GO
IF OBJECT_ID('[Tender].[OFFER_DETAIL_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Tender].[OFFER_DETAIL_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Tender].[OFFER_DETAIL_SAVE]
