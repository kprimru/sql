...
GO
IF OBJECT_ID('[Common].[PERIOD_WEEK_GET_BY_NUMBER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Common].[PERIOD_WEEK_GET_BY_NUMBER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Common].[PERIOD_WEEK_GET_BY_NUMBER]
