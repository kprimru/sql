...
GO
IF OBJECT_ID('[dbo].[CLIENT_SERVICE_DELIVERY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SERVICE_DELIVERY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SERVICE_DELIVERY]
	@CLIENT		NVARCHAR(MAX),
	@SERVICE	INT,
	@DATE		SMALLDATETIME
AS
