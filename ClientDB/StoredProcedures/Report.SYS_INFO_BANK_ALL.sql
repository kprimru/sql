...
GO
IF OBJECT_ID('[Report].[SYS_INFO_BANK_ALL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[SYS_INFO_BANK_ALL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[SYS_INFO_BANK_ALL]
