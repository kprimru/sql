...
GO
IF OBJECT_ID('[Din].[SYSTEM_TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Din].[SYSTEM_TYPE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Din].[SYSTEM_TYPE_SELECT]
