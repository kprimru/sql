...
GO
IF OBJECT_ID('[dbo].[ONLINE_SERVICE_DISTR_SET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[ONLINE_SERVICE_DISTR_SET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[ONLINE_SERVICE_DISTR_SET]
	@Host_Id	SmallInt,
	@Distr		Int,
	@Comp		TinyInt,
	@Hotline	Bit,
