...
GO
IF OBJECT_ID('[Training].[SEMINAR_SIGN_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Training].[SEMINAR_SIGN_GET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Training].[SEMINAR_SIGN_GET]
	@ID			UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
