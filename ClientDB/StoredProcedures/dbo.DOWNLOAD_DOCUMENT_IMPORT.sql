...
GO
IF OBJECT_ID('[dbo].[DOWNLOAD_DOCUMENT_IMPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[DOWNLOAD_DOCUMENT_IMPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[DOWNLOAD_DOCUMENT_IMPORT]
	@DATA	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
