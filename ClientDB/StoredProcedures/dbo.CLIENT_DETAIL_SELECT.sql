...
GO
IF OBJECT_ID('[dbo].[CLIENT_DETAIL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DETAIL_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DETAIL_SELECT]
	@CLIENTID	INT
AS
BEGIN
	SET NOCOUNT ON;
