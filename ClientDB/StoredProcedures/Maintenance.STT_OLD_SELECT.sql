...
GO
IF OBJECT_ID('[Maintenance].[STT_OLD_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[STT_OLD_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[STT_OLD_SELECT]
	@LAST_COUNT	SMALLINT,
