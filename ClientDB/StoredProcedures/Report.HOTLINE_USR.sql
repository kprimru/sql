...
GO
IF OBJECT_ID('[Report].[HOTLINE_USR]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[HOTLINE_USR]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[HOTLINE_USR]
...
BEGIN
	...
	BEGIN TRY
		...
		FROM
			...
			INNER JOIN USR.USRFileTech t ON g.UF_ID = t.UF_ID
...
END
GO
GRANT EXECUTE ON [Report].[HOTLINE_USR] TO rl_report;
GO
