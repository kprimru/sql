...
GO
IF OBJECT_ID('[dbo].[COMPLECT_INFO_BANK_CACHE_RESET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[COMPLECT_INFO_BANK_CACHE_RESET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[COMPLECT_INFO_BANK_CACHE_RESET]
...
BEGIN
	...
	BEGIN TRY
		...
		(
			...
			WHERE	DS_REG = 0
				--AND SubhostName NOT IN ('У1', 'Н1', 'М', 'Л1')
