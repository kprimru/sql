...
GO
IF OBJECT_ID('[Contract].[CONTRACT_SPECIFICATION_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Contract].[CONTRACT_SPECIFICATION_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Contract].[CONTRACT_SPECIFICATION_SELECT]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
