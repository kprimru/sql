...
GO
IF OBJECT_ID('[dbo].[CLIENT_DUTY_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DUTY_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DUTY_UPDATE]
	@ID	INT,
	@CLIENT	INT,
	@DT	DATETIME,
	@CONTACT	VARCHAR(150),
