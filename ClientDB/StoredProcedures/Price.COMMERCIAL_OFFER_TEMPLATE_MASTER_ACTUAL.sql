...
GO
IF OBJECT_ID('[Price].[COMMERCIAL_OFFER_TEMPLATE_MASTER_ACTUAL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Price].[COMMERCIAL_OFFER_TEMPLATE_MASTER_ACTUAL]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Price].[COMMERCIAL_OFFER_TEMPLATE_MASTER_ACTUAL]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
