...
GO
IF OBJECT_ID('[dbo].[SYSTEM_BANKS_ADD(OLD)]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_BANKS_ADD(OLD)]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_BANKS_ADD(OLD)]
