...
GO
IF OBJECT_ID('[dbo].[SERVICE_PAY_TOTAL_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_PAY_TOTAL_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_PAY_TOTAL_REPORT]
