...
GO
IF OBJECT_ID('[Price].[COMMERCIAL_OFFER_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Price].[COMMERCIAL_OFFER_SAVE]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Price].[COMMERCIAL_OFFER_SAVE]
