...
GO
IF OBJECT_ID('[IP].[CLIENT_STAT_DETAIL_CACHE_REFRESH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [IP].[CLIENT_STAT_DETAIL_CACHE_REFRESH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [IP].[CLIENT_STAT_DETAIL_CACHE_REFRESH]
