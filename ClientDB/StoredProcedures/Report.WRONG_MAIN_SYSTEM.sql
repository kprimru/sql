...
GO
IF OBJECT_ID('[Report].[WRONG_MAIN_SYSTEM]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[WRONG_MAIN_SYSTEM]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[WRONG_MAIN_SYSTEM]
