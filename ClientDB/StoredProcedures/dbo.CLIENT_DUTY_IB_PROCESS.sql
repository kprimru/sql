...
GO
IF OBJECT_ID('[dbo].[CLIENT_DUTY_IB_PROCESS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DUTY_IB_PROCESS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DUTY_IB_PROCESS]
	@ClientDutyID INT,
	@IB VARCHAR(MAX)
AS
BEGIN
