...
GO
IF OBJECT_ID('[Maintenance].[JOB_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[JOB_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[JOB_SELECT]
	@Start	DateTime = NULL,
