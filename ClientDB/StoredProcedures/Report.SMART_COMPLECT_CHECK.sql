...
GO
IF OBJECT_ID('[Report].[SMART_COMPLECT_CHECK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[SMART_COMPLECT_CHECK]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[SMART_COMPLECT_CHECK]
