...
GO
IF OBJECT_ID('[dbo].[CLIENT_JOURNAL_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_JOURNAL_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_JOURNAL_UPDATE]
	@ID			UNIQUEIDENTIFIER,
	@CLIENT		INT,
