...
GO
IF OBJECT_ID('[dbo].[CLIENT_TRUST_PROCESS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_TRUST_PROCESS]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_TRUST_PROCESS]
