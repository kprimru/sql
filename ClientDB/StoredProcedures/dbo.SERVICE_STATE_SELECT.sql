...
GO
IF OBJECT_ID('[dbo].[SERVICE_STATE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_STATE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_STATE_SELECT]
	@SERVICE	INT,
