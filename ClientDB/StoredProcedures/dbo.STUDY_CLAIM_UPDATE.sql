...
GO
IF OBJECT_ID('[dbo].[STUDY_CLAIM_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_CLAIM_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_CLAIM_UPDATE]
	@ID			UNIQUEIDENTIFIER,
	@CLIENT		INT,
	@DATE		SMALLDATETIME,
	@STUDY		SMALLDATETIME,
