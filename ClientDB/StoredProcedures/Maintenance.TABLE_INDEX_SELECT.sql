...
GO
IF OBJECT_ID('[Maintenance].[TABLE_INDEX_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Maintenance].[TABLE_INDEX_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Maintenance].[TABLE_INDEX_SELECT]
