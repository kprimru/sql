...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONTRACT_FOUNDATION]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONTRACT_FOUNDATION]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONTRACT_FOUNDATION]
	@ID		INT,
