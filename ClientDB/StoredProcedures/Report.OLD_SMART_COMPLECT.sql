...
GO
IF OBJECT_ID('[Report].[OLD_SMART_COMPLECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[OLD_SMART_COMPLECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[OLD_SMART_COMPLECT]
