...
GO
IF OBJECT_ID('[dbo].[CLIENT_HOTLINE_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_HOTLINE_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_HOTLINE_PRINT]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
