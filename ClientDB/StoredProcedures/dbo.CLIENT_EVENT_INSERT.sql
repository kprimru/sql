...
GO
IF OBJECT_ID('[dbo].[CLIENT_EVENT_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_EVENT_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_EVENT_INSERT]
	@CLIENT		INT,
	@DATE		SMALLDATETIME,
	@TYPE		INT,
	@COMMENT	VARCHAR(MAX),
