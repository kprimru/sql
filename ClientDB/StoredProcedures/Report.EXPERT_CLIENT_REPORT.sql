...
GO
IF OBJECT_ID('[Report].[EXPERT_CLIENT_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[EXPERT_CLIENT_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[EXPERT_CLIENT_REPORT]
