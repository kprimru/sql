...
GO
IF OBJECT_ID('[dbo].[SYSTEM_BANKS_GET(OLD)]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_BANKS_GET(OLD)]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_BANKS_GET(OLD)]
