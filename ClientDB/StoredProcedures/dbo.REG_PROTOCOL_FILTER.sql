...
GO
IF OBJECT_ID('[dbo].[REG_PROTOCOL_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[REG_PROTOCOL_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[REG_PROTOCOL_FILTER]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@SYS	INT,
	@DISTR	INT,
