...
GO
IF OBJECT_ID('[dbo].[SYSTEM_LEFT_BANKS_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_LEFT_BANKS_GET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE	[dbo].[SYSTEM_LEFT_BANKS_GET]
