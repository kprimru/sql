...
GO
IF OBJECT_ID('[USR].[SERVICE_COMMON_GRAPH_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[SERVICE_COMMON_GRAPH_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[SERVICE_COMMON_GRAPH_PRINT]
	@SERVICE	INT,
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
