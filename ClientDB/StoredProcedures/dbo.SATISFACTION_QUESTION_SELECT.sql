...
GO
IF OBJECT_ID('[dbo].[SATISFACTION_QUESTION_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SATISFACTION_QUESTION_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SATISFACTION_QUESTION_SELECT]
