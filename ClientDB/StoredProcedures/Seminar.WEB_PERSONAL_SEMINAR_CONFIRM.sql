...
GO
IF OBJECT_ID('[Seminar].[WEB_PERSONAL_SEMINAR_CONFIRM]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Seminar].[WEB_PERSONAL_SEMINAR_CONFIRM]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Seminar].[WEB_PERSONAL_SEMINAR_CONFIRM]
	@ID			UNIQUEIDENTIFIER,
