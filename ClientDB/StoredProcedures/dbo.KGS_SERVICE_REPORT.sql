...
GO
IF OBJECT_ID('[dbo].[KGS_SERVICE_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[KGS_SERVICE_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[KGS_SERVICE_REPORT]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@LIST	INT
AS
