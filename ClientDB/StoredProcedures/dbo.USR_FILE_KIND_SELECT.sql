...
GO
IF OBJECT_ID('[dbo].[USR_FILE_KIND_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[USR_FILE_KIND_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[USR_FILE_KIND_SELECT]
