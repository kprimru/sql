...
GO
IF OBJECT_ID('[USR].[RES_VERSION_CHECK_OLD]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[RES_VERSION_CHECK_OLD]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[RES_VERSION_CHECK_OLD]
	@MANAGER	INT,
	@SERVICE	INT,
	@DATE		SMALLDATETIME,
	@STATUS		VARCHAR(MAX),
