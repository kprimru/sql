...
GO
IF OBJECT_ID('[Price].[COMMERCIAL_OFFER_FILTER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Price].[COMMERCIAL_OFFER_FILTER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Price].[COMMERCIAL_OFFER_FILTER]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@CLIENT	VARCHAR(200),
	@STATUS	INT,
