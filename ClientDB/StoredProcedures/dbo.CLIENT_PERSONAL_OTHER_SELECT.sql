...
GO
IF OBJECT_ID('[dbo].[CLIENT_PERSONAL_OTHER_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_PERSONAL_OTHER_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_PERSONAL_OTHER_SELECT]
	@CLIENT	INT
AS
BEGIN
	SET NOCOUNT ON;
