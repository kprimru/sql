...
GO
IF OBJECT_ID('[dbo].[SERVICE_REPORT_CREATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_REPORT_CREATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_REPORT_CREATE]
	@SERVICE	INT,
	@MANAGER	INT,
	@CSTATUS	VARCHAR(MAX),
	@SSTATUS	VARCHAR(MAX),
