...
GO
IF OBJECT_ID('[dbo].[SUBHOST_IMPORT_DATA_NEW]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SUBHOST_IMPORT_DATA_NEW]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SUBHOST_IMPORT_DATA_NEW]
	@InData	NVarChar(Max)
AS
BEGIN
	SET NOCOUNT ON;
