...
GO
IF OBJECT_ID('[dbo].[SET_BLACKLIST_PARAM]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SET_BLACKLIST_PARAM]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [dbo].[SET_BLACKLIST_PARAM]
