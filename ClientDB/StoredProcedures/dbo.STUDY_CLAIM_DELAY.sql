...
GO
IF OBJECT_ID('[dbo].[STUDY_CLAIM_DELAY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_CLAIM_DELAY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_CLAIM_DELAY]
	@ID			UNIQUEIDENTIFIER,
	@DATE		SMALLDATETIME,
	@TEACHER	INT,
...
END
GO
GRANT EXECUTE ON [dbo].[STUDY_CLAIM_DELAY] TO rl_client_study_i;
GO
