...
GO
IF OBJECT_ID('[dbo].[IMPORT_CLIENT_STAT_DATA]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[IMPORT_CLIENT_STAT_DATA]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[IMPORT_CLIENT_STAT_DATA]
	@DATA		NVARCHAR(MAX),
