...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONTROL_READ]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONTROL_READ]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONTROL_READ]
	@CC_ID	INT
AS
BEGIN
	SET NOCOUNT ON;
