...
GO
IF OBJECT_ID('[dbo].[STUDY_CLAIM_WORK_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_CLAIM_WORK_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_CLAIM_WORK_SAVE]
	@ID			UNIQUEIDENTIFIER,
