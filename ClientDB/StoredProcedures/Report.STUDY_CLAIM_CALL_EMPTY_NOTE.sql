...
GO
IF OBJECT_ID('[Report].[STUDY_CLAIM_CALL_EMPTY_NOTE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[STUDY_CLAIM_CALL_EMPTY_NOTE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[STUDY_CLAIM_CALL_EMPTY_NOTE]
