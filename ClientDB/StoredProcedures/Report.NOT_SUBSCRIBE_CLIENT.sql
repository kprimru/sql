...
GO
IF OBJECT_ID('[Report].[NOT_SUBSCRIBE_CLIENT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[NOT_SUBSCRIBE_CLIENT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[NOT_SUBSCRIBE_CLIENT]
