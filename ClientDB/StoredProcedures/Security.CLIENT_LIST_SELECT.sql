...
GO
IF OBJECT_ID('[Security].[CLIENT_LIST_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Security].[CLIENT_LIST_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Security].[CLIENT_LIST_SELECT]
	@FILTER	VARCHAR(100)
