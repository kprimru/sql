...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_DELIVERY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_DELIVERY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_DELIVERY]
	@ID		VARCHAR(MAX),
	@CLIENT	INT
AS
BEGIN
