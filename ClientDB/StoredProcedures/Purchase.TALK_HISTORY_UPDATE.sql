...
GO
IF OBJECT_ID('[Purchase].[TALK_HISTORY_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[TALK_HISTORY_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[TALK_HISTORY_UPDATE]
	@ID		UNIQUEIDENTIFIER,
	@CLIENT	INT,
	@DATE	SMALLDATETIME,
	@WHO	VARCHAR(150),
