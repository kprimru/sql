...
GO
IF OBJECT_ID('[Din].[SYSTEM_TYPE_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Din].[SYSTEM_TYPE_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Din].[SYSTEM_TYPE_UPDATE]
	@ID	INT,
	@NAME	VARCHAR(100),
	@SHORT	VARCHAR(20),
	@NOTE	VARCHAR(100),
