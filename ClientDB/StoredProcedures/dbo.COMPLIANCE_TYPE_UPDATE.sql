...
GO
IF OBJECT_ID('[dbo].[COMPLIANCE_TYPE_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[COMPLIANCE_TYPE_UPDATE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[COMPLIANCE_TYPE_UPDATE]
	@ID	INT,
	@NAME	VARCHAR(100),
	@SHORT	VARCHAR(100),
	@ORDER	INT
