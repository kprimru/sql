...
GO
IF OBJECT_ID('[Salary].[SERVICE_SALARY_DISTR_IMPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[SERVICE_SALARY_DISTR_IMPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Salary].[SERVICE_SALARY_DISTR_IMPORT]
	@ID			UNIQUEIDENTIFIER,
	@CLIENT		NVARCHAR(512),
	@HOST		INT,
	@DISTR		INT,
