...
GO
IF OBJECT_ID('[dbo].[CLIENT_INNOVATION_PERSONAL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_INNOVATION_PERSONAL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_INNOVATION_PERSONAL]
	@ID			UNIQUEIDENTIFIER,
