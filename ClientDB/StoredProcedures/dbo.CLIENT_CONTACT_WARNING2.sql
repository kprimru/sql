...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONTACT_WARNING2]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONTACT_WARNING2]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONTACT_WARNING2]
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_CONTACT_WARNING2] TO rl_contact_warning;
GO
