...
GO
IF OBJECT_ID('[Training].[SEMINAR_SIGN_CANCEL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Training].[SEMINAR_SIGN_CANCEL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Training].[SEMINAR_SIGN_CANCEL]
	@ID		UNIQUEIDENTIFIER,
	@STATUS	TINYINT = NULL
AS
BEGIN
