...
GO
IF OBJECT_ID('[Training].[SEMINAR_SIGN_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Training].[SEMINAR_SIGN_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Training].[SEMINAR_SIGN_PRINT]
