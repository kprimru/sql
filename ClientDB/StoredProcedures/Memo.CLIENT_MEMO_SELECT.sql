...
GO
IF OBJECT_ID('[Memo].[CLIENT_MEMO_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Memo].[CLIENT_MEMO_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Memo].[CLIENT_MEMO_SELECT]
	@CLIENT	INT
AS
BEGIN
	SET NOCOUNT ON;
