...
GO
IF OBJECT_ID('[dbo].[CLIENT_RIVAL_REACTION_EDIT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_RIVAL_REACTION_EDIT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_RIVAL_REACTION_EDIT]
	@CRR_ID	INT,
	@DATE	SMALLDATETIME,
	@COMM	VARCHAR(MAX),
	@COMPLETE	BIT,
