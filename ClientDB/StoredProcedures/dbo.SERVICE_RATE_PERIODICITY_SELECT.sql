...
GO
IF OBJECT_ID('[dbo].[SERVICE_RATE_PERIODICITY_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_RATE_PERIODICITY_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_RATE_PERIODICITY_SELECT]
	@BEGIN		SMALLDATETIME,
	@END		SMALLDATETIME,
	@SERVICE	INT,
	@MANAGER	VARCHAR(MAX),
...
END
GO
GRANT EXECUTE ON [dbo].[SERVICE_RATE_PERIODICITY_SELECT] TO rl_service_rate;
GO
