...
GO
IF OBJECT_ID('[Price].[COMMERCIAL_OFFER_DETAIL_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Price].[COMMERCIAL_OFFER_DETAIL_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Price].[COMMERCIAL_OFFER_DETAIL_PRINT]
	@ID	UNIQUEIDENTIFIER
