...
GO
IF OBJECT_ID('[dbo].[TEACHER_REPORT_RDD_CREATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[TEACHER_REPORT_RDD_CREATE]  AS SELECT 1')
GO
...
CREATE OR ALTER PROCEDURE [dbo].[TEACHER_REPORT_RDD_CREATE]
