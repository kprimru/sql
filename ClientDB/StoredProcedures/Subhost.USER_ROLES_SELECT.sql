...
GO
IF OBJECT_ID('[Subhost].[USER_ROLES_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[USER_ROLES_SELECT]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Subhost].[USER_ROLES_SELECT]
