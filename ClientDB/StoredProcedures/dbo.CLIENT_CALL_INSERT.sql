...
GO
IF OBJECT_ID('[dbo].[CLIENT_CALL_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CALL_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CALL_INSERT]
	@CLIENT		INT,
	@DATE		SMALLDATETIME,
