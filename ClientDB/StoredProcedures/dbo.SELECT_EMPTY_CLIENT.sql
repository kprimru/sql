...
GO
IF OBJECT_ID('[dbo].[SELECT_EMPTY_CLIENT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SELECT_EMPTY_CLIENT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SELECT_EMPTY_CLIENT]
AS
BEGIN
	SET NOCOUNT ON;
