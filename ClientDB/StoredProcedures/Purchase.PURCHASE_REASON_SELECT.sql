...
GO
IF OBJECT_ID('[Purchase].[PURCHASE_REASON_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[PURCHASE_REASON_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[PURCHASE_REASON_SELECT]
