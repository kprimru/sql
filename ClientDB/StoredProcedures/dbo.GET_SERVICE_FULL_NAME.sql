...
GO
IF OBJECT_ID('[dbo].[GET_SERVICE_FULL_NAME]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[GET_SERVICE_FULL_NAME]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[GET_SERVICE_FULL_NAME]
	@serviceid INT
AS
BEGIN
	SET NOCOUNT ON
