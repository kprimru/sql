...
GO
IF OBJECT_ID('[Report].[CHAT_SUBHOST_EXTENDED]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[CHAT_SUBHOST_EXTENDED]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[CHAT_SUBHOST_EXTENDED]
...
END
GO
GRANT EXECUTE ON [Report].[CHAT_SUBHOST_EXTENDED] TO rl_report;
GO
