...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONTRACT_PREPARE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONTRACT_PREPARE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONTRACT_PREPARE]
	@CLIENT	INT,
