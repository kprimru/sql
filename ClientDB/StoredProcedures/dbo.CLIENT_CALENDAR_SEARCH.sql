...
GO
IF OBJECT_ID('[dbo].[CLIENT_CALENDAR_SEARCH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CALENDAR_SEARCH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CALENDAR_SEARCH]
