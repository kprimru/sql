...
GO
IF OBJECT_ID('[Purchase].[CLAIM_PROVISION_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Purchase].[CLAIM_PROVISION_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Purchase].[CLAIM_PROVISION_SELECT]
