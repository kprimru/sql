...
GO
IF OBJECT_ID('[dbo].[STAT_XML_IMPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STAT_XML_IMPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STAT_XML_IMPORT]
	@DATA	NVARCHAR(MAX),
	@NEW	INT = NULL OUTPUT,
...
END
GO
GRANT EXECUTE ON [dbo].[STAT_XML_IMPORT] TO rl_stat_import;
GO
