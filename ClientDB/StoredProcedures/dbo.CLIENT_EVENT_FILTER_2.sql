...
GO
IF OBJECT_ID('[dbo].[CLIENT_EVENT_FILTER_2]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_EVENT_FILTER_2]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_EVENT_FILTER_2]
	@START		SMALLDATETIME,
