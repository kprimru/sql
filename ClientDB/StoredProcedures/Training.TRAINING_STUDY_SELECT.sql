...
GO
IF OBJECT_ID('[Training].[TRAINING_STUDY_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Training].[TRAINING_STUDY_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Training].[TRAINING_STUDY_SELECT]
	@ID		UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
