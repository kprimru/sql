...
GO
IF OBJECT_ID('[Price].[COMMERCIAL_OFFER_DETAIL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Price].[COMMERCIAL_OFFER_DETAIL_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Price].[COMMERCIAL_OFFER_DETAIL_SELECT]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
