...
GO
IF OBJECT_ID('[dbo].[ACT_CALC_EXISTS_DETAIL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[ACT_CALC_EXISTS_DETAIL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[ACT_CALC_EXISTS_DETAIL]
	@ID		UNIQUEIDENTIFIER,
	@CONFRM	BIT = NULL
AS
BEGIN
