...
GO
IF OBJECT_ID('[dbo].[CLIENT_INNOVATION_CONTROL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_INNOVATION_CONTROL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_INNOVATION_CONTROL]
