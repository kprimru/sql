...
GO
IF OBJECT_ID('[Contract].[CLIENT_CONTRACT_DELETE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Contract].[CLIENT_CONTRACT_DELETE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Contract].[CLIENT_CONTRACT_DELETE]
	@ID	UniqueIdentifier
AS
BEGIN
	SET NOCOUNT ON;
