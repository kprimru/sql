...
GO
IF OBJECT_ID('[dbo].[CLIENT_RIVAL_REACTION_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_RIVAL_REACTION_GET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_RIVAL_REACTION_GET]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
