...
GO
IF OBJECT_ID('[dbo].[SYSTEM_TYPE_COEF_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SYSTEM_TYPE_COEF_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SYSTEM_TYPE_COEF_SAVE]
	@TYPE		Int,
