...
GO
IF OBJECT_ID('[dbo].[STUDY_CLAIM_CANCEL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_CLAIM_CANCEL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_CLAIM_CANCEL]
	@ID			UNIQUEIDENTIFIER,
...
END
GO
GRANT EXECUTE ON [dbo].[STUDY_CLAIM_CANCEL] TO rl_client_study_claim_cancel;
GO
