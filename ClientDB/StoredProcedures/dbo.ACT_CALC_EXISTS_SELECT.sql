...
GO
CREATE OR ALTER PROCEDURE [dbo].[ACT_CALC_EXISTS_SELECT]
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT ID, DATE, USR, STATUS, 'Заявка создана' AS ST_TEXT, SERVICE, CONFIRM_NEED, CONFIRM_USER, CONFIRM_DATE, CALC_STATUS
		FROM dbo.ActCalc a
		WHERE a.STATUS = 1
