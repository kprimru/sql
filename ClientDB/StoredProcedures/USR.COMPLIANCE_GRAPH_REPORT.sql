...
GO
IF OBJECT_ID('[USR].[COMPLIANCE_GRAPH_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[COMPLIANCE_GRAPH_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[COMPLIANCE_GRAPH_REPORT]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@MANAGER	INT,
	@SERVICE	INT,
