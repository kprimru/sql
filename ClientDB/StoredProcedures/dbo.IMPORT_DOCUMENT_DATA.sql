...
GO
IF OBJECT_ID('[dbo].[IMPORT_DOCUMENT_DATA]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[IMPORT_DOCUMENT_DATA]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[IMPORT_DOCUMENT_DATA]
	@DATA		NVARCHAR(MAX),
