...
GO
IF OBJECT_ID('[dbo].[CLIENT_AUDIT_DEFAULT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_AUDIT_DEFAULT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_AUDIT_DEFAULT]
	@CLIENT	INT
AS
BEGIN
	SET NOCOUNT ON;
