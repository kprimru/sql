...
GO
IF OBJECT_ID('[dbo].[CLIENT_STUDY_CLAIM_MEETING_REPORT_PRINT_2]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_STUDY_CLAIM_MEETING_REPORT_PRINT_2]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_STUDY_CLAIM_MEETING_REPORT_PRINT_2]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME
AS
BEGIN
