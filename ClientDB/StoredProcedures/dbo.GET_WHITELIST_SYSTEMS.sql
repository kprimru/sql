...
GO
IF OBJECT_ID('[dbo].[GET_WHITELIST_SYSTEMS]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[GET_WHITELIST_SYSTEMS]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [dbo].[GET_WHITELIST_SYSTEMS]
