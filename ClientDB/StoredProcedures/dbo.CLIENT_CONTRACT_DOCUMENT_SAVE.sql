...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONTRACT_DOCUMENT_SAVE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONTRACT_DOCUMENT_SAVE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONTRACT_DOCUMENT_SAVE]
	@ID			UNIQUEIDENTIFIER,
	@CONTRACT	INT,
