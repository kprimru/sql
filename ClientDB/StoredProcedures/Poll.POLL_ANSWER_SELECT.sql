...
GO
IF OBJECT_ID('[Poll].[POLL_ANSWER_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Poll].[POLL_ANSWER_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Poll].[POLL_ANSWER_SELECT]
