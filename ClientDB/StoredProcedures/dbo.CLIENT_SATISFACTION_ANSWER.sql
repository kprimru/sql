...
GO
IF OBJECT_ID('[dbo].[CLIENT_SATISFACTION_ANSWER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_SATISFACTION_ANSWER]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_SATISFACTION_ANSWER]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
