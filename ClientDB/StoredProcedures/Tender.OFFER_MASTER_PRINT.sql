...
GO
IF OBJECT_ID('[Tender].[OFFER_MASTER_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Tender].[OFFER_MASTER_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Tender].[OFFER_MASTER_PRINT]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
