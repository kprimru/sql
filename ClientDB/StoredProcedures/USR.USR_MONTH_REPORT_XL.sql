...
GO
IF OBJECT_ID('[USR].[USR_MONTH_REPORT_XL]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[USR_MONTH_REPORT_XL]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[USR_MONTH_REPORT_XL]
