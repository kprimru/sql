...
GO
IF OBJECT_ID('[dbo].[SERVICE_GRAPH_WARNING]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_GRAPH_WARNING]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_GRAPH_WARNING]
AS
BEGIN
	SET NOCOUNT ON;
