...
GO
IF OBJECT_ID('[dbo].[CLIENT_STAT_DETAIL_AVG_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_STAT_DETAIL_AVG_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_STAT_DETAIL_AVG_INSERT]
