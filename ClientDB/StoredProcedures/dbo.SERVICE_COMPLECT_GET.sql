...
GO
IF OBJECT_ID('[dbo].[SERVICE_COMPLECT_GET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SERVICE_COMPLECT_GET]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SERVICE_COMPLECT_GET]
	@ID_SERVICE INT
AS
BEGIN
	SET NOCOUNT ON;
