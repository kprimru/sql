...
GO
IF OBJECT_ID('[dbo].[SELECT_CLIENT_WITHOUT_CONTRACT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[SELECT_CLIENT_WITHOUT_CONTRACT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[SELECT_CLIENT_WITHOUT_CONTRACT]
	@managerid INT = NULL,
	@statusid INT = 2
AS
BEGIN
