...
GO
IF OBJECT_ID('[Reg].[REG_PROTOCOL_SEARCH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Reg].[REG_PROTOCOL_SEARCH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Reg].[REG_PROTOCOL_SEARCH]
