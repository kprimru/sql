...
GO
IF OBJECT_ID('[USR].[COMPLECT_UNSERVICE_SYSTEM_OLD]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[COMPLECT_UNSERVICE_SYSTEM_OLD]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[COMPLECT_UNSERVICE_SYSTEM_OLD]
	@MANAGER	INT,
	@SERVICE	INT,
