...
GO
IF OBJECT_ID('[Training].[CLIENT_SEMINAR_VISIT_OFTEN_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Training].[CLIENT_SEMINAR_VISIT_OFTEN_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Training].[CLIENT_SEMINAR_VISIT_OFTEN_REPORT]
	@BEGIN SMALLDATETIME,
	@END SMALLDATETIME,
	@SERVICE INT,
	@MANAGER INT,
