...
GO
IF OBJECT_ID('[Contract].[CONTRACT_EXPECTED_NUM]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Contract].[CONTRACT_EXPECTED_NUM]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Contract].[CONTRACT_EXPECTED_NUM]
	@DATE		SMALLDATETIME,
