...
GO
IF OBJECT_ID('[Din].[DIN_NET_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Din].[DIN_NET_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Din].[DIN_NET_SELECT]
	@MANAGER	INT,
	@SERVICE	INT,
	@TYPE		VARCHAR(MAX)
AS
...
END
GO
GRANT EXECUTE ON [Din].[DIN_NET_SELECT] TO rl_din_exchange;
GO
