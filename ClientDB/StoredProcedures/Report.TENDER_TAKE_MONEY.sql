...
GO
IF OBJECT_ID('[Report].[TENDER_TAKE_MONEY]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Report].[TENDER_TAKE_MONEY]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [Report].[TENDER_TAKE_MONEY]
