...
GO
IF OBJECT_ID('[Subhost].[PERSONAL_TEST_QUESTION_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Subhost].[PERSONAL_TEST_QUESTION_SELECT]  AS SELECT 1')
GO

CREATE OR ALTER PROCEDURE [Subhost].[PERSONAL_TEST_QUESTION_SELECT]
