...
GO
IF OBJECT_ID('[dbo].[CLIENT_CONNECT_SYSTEM]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_CONNECT_SYSTEM]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_CONNECT_SYSTEM]
	@CLIENT	NVARCHAR(MAX)
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_CONNECT_SYSTEM] TO rl_client_connect;
GO
