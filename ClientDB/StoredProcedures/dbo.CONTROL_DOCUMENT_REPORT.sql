...
GO
IF OBJECT_ID('[dbo].[CONTROL_DOCUMENT_REPORT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CONTROL_DOCUMENT_REPORT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CONTROL_DOCUMENT_REPORT]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@MANAGER	INT,
	@SERVICE	INT,
