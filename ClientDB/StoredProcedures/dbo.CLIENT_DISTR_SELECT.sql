...
GO
IF OBJECT_ID('[dbo].[CLIENT_DISTR_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DISTR_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DISTR_SELECT]
	@CLIENTID	INT,
	@HISTORY	BIT = 0,
