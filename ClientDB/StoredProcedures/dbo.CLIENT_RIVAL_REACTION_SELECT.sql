...
GO
IF OBJECT_ID('[dbo].[CLIENT_RIVAL_REACTION_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_RIVAL_REACTION_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_RIVAL_REACTION_SELECT]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[CLIENT_RIVAL_REACTION_SELECT] TO rl_client_rival_reaction_r;
GO
