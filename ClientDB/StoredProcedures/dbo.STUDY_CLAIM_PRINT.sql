...
GO
IF OBJECT_ID('[dbo].[STUDY_CLAIM_PRINT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[STUDY_CLAIM_PRINT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[STUDY_CLAIM_PRINT]
	@ID	UNIQUEIDENTIFIER
AS
BEGIN
	SET NOCOUNT ON;
...
END
GO
GRANT EXECUTE ON [dbo].[STUDY_CLAIM_PRINT] TO rl_client_study_claim_r;
GO
