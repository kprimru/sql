...
GO
IF OBJECT_ID('[dbo].[CLIENT_DUTY_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_DUTY_INSERT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_DUTY_INSERT]
	@CLIENT	INT,
	@DT	DATETIME,
	@CONTACT	VARCHAR(150),
	@POS	VARCHAR(50),
