...
GO
IF OBJECT_ID('[dbo].[CONTRACT_TYPE_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CONTRACT_TYPE_SELECT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CONTRACT_TYPE_SELECT]
