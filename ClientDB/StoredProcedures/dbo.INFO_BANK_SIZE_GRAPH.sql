...
GO
IF OBJECT_ID('[dbo].[INFO_BANK_SIZE_GRAPH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[INFO_BANK_SIZE_GRAPH]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[INFO_BANK_SIZE_GRAPH]
	@BEGIN	SMALLDATETIME,
	@END	SMALLDATETIME,
	@SYS	VARCHAR(MAX),
