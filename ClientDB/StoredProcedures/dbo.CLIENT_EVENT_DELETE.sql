...
GO
IF OBJECT_ID('[dbo].[CLIENT_EVENT_DELETE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [dbo].[CLIENT_EVENT_DELETE]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [dbo].[CLIENT_EVENT_DELETE]
	@ID	INT
AS
BEGIN
	SET NOCOUNT ON;
