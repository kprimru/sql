...
GO
IF OBJECT_ID('[USR].[CLIENT_SYSTEM_AUDIT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [USR].[CLIENT_SYSTEM_AUDIT]  AS SELECT 1')
GO
CREATE OR ALTER PROCEDURE [USR].[CLIENT_SYSTEM_AUDIT]
	@MANAGER	INT = NULL,
	@SERVICE	INT = NULL,
