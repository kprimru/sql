...
GO
IF OBJECT_ID('[Salary].[SALARY_CONDITION_CHRONO]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[SALARY_CONDITION_CHRONO]  AS SELECT 1')
GO
ALTER PROCEDURE [Salary].[SALARY_CONDITION_CHRONO]
