...
GO
IF OBJECT_ID('[Income].[INCOME_FULL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Income].[INCOME_FULL_SELECT]  AS SELECT 1')
GO


ALTER PROCEDURE [Income].[INCOME_FULL_SELECT]
...
BEGIN
	...
	SELECT
		...
		ID_LOCK, ID_RESTORE, ID_MAIN, ID_COLOR, ID_ORANGE '
