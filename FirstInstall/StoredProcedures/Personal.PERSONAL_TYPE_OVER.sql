...
GO
IF OBJECT_ID('[Personal].[PERSONAL_TYPE_OVER]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Personal].[PERSONAL_TYPE_OVER]  AS SELECT 1')
GO
ALTER PROCEDURE [Personal].[PERSONAL_TYPE_OVER]
	@IDLIST	VARCHAR(MAX),
	@DATE	SMALLDATETIME,
	@RC		INT = NULL OUTPUT
AS
