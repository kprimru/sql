...
GO
IF OBJECT_ID('[Personal].[PERSONAL_FROM_CLIENT_REFRESH]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Personal].[PERSONAL_FROM_CLIENT_REFRESH]  AS SELECT 1')
GO
ALTER PROCEDURE [Personal].[PERSONAL_FROM_CLIENT_REFRESH]
