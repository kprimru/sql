...
GO
IF OBJECT_ID('[Income].[INCOME_UPDATE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Income].[INCOME_UPDATE]  AS SELECT 1')
GO
ALTER PROCEDURE [Income].[INCOME_UPDATE]
...
END
GO
GRANT EXECUTE ON [Income].[INCOME_UPDATE] TO rl_income_w;
GO
