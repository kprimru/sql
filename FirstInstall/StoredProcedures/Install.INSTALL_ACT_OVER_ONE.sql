...
GO
IF OBJECT_ID('[Install].[INSTALL_ACT_OVER_ONE]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Install].[INSTALL_ACT_OVER_ONE]  AS SELECT 1')
GO
ALTER PROCEDURE [Install].[INSTALL_ACT_OVER_ONE]
