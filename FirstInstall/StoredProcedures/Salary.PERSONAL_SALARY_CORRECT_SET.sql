...
GO
IF OBJECT_ID('[Salary].[PERSONAL_SALARY_CORRECT_SET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[PERSONAL_SALARY_CORRECT_SET]  AS SELECT 1')
GO
...
BEGIN
	...
	EXEC Common.PROTOCOL_INSERT 'PERSONAL_SALARY', 'Коррекционная сумма', @PS_ID, @OLD, @NEW
