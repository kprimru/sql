...
GO
IF OBJECT_ID('[Install].[INSTALL_FULL_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Install].[INSTALL_FULL_SELECT]  AS SELECT 1')
GO



ALTER PROCEDURE [Install].[INSTALL_FULL_SELECT]
