...
GO
IF OBJECT_ID('[Salary].[SALARY_CONDITION_OVER_NEW]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[SALARY_CONDITION_OVER_NEW]  AS SELECT 1')
GO
ALTER PROCEDURE [Salary].[SALARY_CONDITION_OVER_NEW]
