...
GO
IF OBJECT_ID('[Income].[INCOME_PERSONAL_DEFAULT_SET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Income].[INCOME_PERSONAL_DEFAULT_SET]  AS SELECT 1')
GO
ALTER PROCEDURE [Income].[INCOME_PERSONAL_DEFAULT_SET]
	@ID_ID		NVARCHAR(MAX),
...
END
GO
GRANT EXECUTE ON [Income].[INCOME_PERSONAL_DEFAULT_SET] TO rl_income_personal;
GO
