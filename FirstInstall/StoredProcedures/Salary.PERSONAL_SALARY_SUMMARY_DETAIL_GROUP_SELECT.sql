...
GO
IF OBJECT_ID('[Salary].[PERSONAL_SALARY_SUMMARY_DETAIL_GROUP_SELECT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[PERSONAL_SALARY_SUMMARY_DETAIL_GROUP_SELECT]  AS SELECT 1')
GO
