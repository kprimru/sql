...
GO
IF OBJECT_ID('[Install].[INSTALL_ACT_DATE_SET]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Install].[INSTALL_ACT_DATE_SET]  AS SELECT 1')
GO
...
BEGIN
	...
	BEGIN
		...
		EXEC Common.PROTOCOL_INSERT 'INSTALL_DETAIL', 'Дата актов', @ID, @OLD, @NEW
