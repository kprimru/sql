...
GO
IF OBJECT_ID('[Income].[INCOME_DETAIL_INSERT]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Income].[INCOME_DETAIL_INSERT]  AS SELECT 1')
GO
ALTER PROCEDURE [Income].[INCOME_DETAIL_INSERT]
...
END
GO
GRANT EXECUTE ON [Income].[INCOME_DETAIL_INSERT] TO rl_income_w;
GO
