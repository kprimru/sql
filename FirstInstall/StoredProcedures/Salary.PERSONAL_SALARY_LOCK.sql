...
GO
IF OBJECT_ID('[Salary].[PERSONAL_SALARY_LOCK]', 'P ') IS NULL EXEC('CREATE PROCEDURE [Salary].[PERSONAL_SALARY_LOCK]  AS SELECT 1')
GO
ALTER PROCEDURE [Salary].[PERSONAL_SALARY_LOCK]
	@PS_ID	VARCHAR(MAX),
	@LOCK	BIT
AS
BEGIN
