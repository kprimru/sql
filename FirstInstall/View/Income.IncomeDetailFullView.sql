...
GO
IF OBJECT_ID('[Income].[IncomeDetailFullView]', 'V ') IS NULL EXEC('CREATE VIEW [Income].[IncomeDetailFullView]  AS SELECT 1')
GO
...
AS
	SELECT
		...
		SYS_ID, SYS_ID_MASTER, SYS_SHORT, SYS_ORDER, ID_MAIN, ID_COLOR, ID_ORANGE,
		CASE 
			WHEN EXISTS(
				SELECT *
