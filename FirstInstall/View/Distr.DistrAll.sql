...
GO
IF OBJECT_ID('[Distr].[DistrAll]', 'V ') IS NULL EXEC('CREATE VIEW [Distr].[DistrAll]  AS SELECT 1')
GO
ALTER VIEW [Distr].[DistrAll]
--WITH SCHEMABINDING
AS
	SELECT
	...
	FROM
		...
		Distr.TechTypeLast ON TT_ID_MASTER = DH_ID_TECHGO
