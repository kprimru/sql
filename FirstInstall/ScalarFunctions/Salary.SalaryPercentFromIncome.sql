...
BEGIN	
	...
	FROM 
		(
			SELECT 
				...
				ID_ACTION, ID_EXCHANGE, ID_RESTORE, ID_MON_CNT,
	...
	DECLARE BONUS CURSOR LOCAL FOR
		SELECT 
			BC_ID, BC_PREPAY, BC_MON_COUNT, BC_ACTION, BC_EXCHANGE,
	...
	BEGIN
		...
		*/
		IF
			...
			(@ID_EXCHANGE = ISNULL(@BC_EXCHANGE, @ID_EXCHANGE)) AND
