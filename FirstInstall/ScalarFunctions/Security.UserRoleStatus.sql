...
GO
IF OBJECT_ID('[Security].[UserRoleStatus]', 'FN') IS NULL EXEC('CREATE FUNCTION [Security].[UserRoleStatus] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE FUNCTION [Security].[UserRoleStatus]
(
