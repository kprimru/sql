...
GO
IF OBJECT_ID('[Salary].[PersonalWeightCalc]', 'FN') IS NULL EXEC('CREATE FUNCTION [Salary].[PersonalWeightCalc] () RETURNS Int AS BEGIN RETURN NULL END')
GO
CREATE FUNCTION [Salary].[PersonalWeightCalc]
(
