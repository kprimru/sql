...
CREATE NONCLUSTERED INDEX [IX_dbo.LogFiles(LF_TYPE,LF_DATE)+(LF_SYS,LF_DISTR,LF_COMP)] ON [dbo].[LogFiles] ([LF_TYPE] ASC, [LF_DATE] ASC) INCLUDE ([LF_SYS], [LF_DISTR], [LF_COMP]);
GO
