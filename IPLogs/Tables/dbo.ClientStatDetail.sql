...
GO
CREATE NONCLUSTERED INDEX [IX_dbo.ClientStatDetail(CSD_DISTR,CSD_SYS,CSD_COMP,CSD_START,CSD_END)+(CSD_ID)] ON [dbo].[ClientStatDetail] ([CSD_DISTR] ASC, [CSD_SYS] ASC, [CSD_COMP] ASC, [CSD_START] ASC, [CSD_END] ASC);
