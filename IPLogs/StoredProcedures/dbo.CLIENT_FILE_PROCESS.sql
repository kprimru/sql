...
BEGIN
	...
	BEGIN TRY
	    ...
	    --ÂÎÒ ÑÞÄÀ ÏÎÄÎÁÍÎÅ ÒÎÌÓ ×ÒÎ ÑÂÅÐÕÓ, ÒÎËÜÊÎ Ñ ÇÀÌÅÍÎÉ È Â 275TS ClientDB
	    --ÅÑËÈ ×ÒÎ ÓÄÀËßÒÜ ÂÑÅ
	    ---------------------------------------------------------------------------
	    UPDATE b
